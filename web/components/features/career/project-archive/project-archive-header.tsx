    ...
    <div className="mb-10 flex min-w-0 flex-col justify-between gap-6 xl:flex-row xl:items-end">
      ...
      <div className="flex min-w-0 flex-wrap items-center gap-2 xl:shrink-0">
        ...
        <Button
          ...
          title={selectionMode ? "작성 모드 취소" : "자소서 작성 모드"}
          aria-label={selectionMode ? "작성 모드 취소" : "자소서 작성 모드"}
          className={cn(
            "h-12 shrink-0 gap-2 rounded-full font-bold shadow-sm transition-all duration-300",
            "w-12 justify-center px-0 2xl:w-auto 2xl:px-6",
            selectionMode
        ...
        <Button
          ...
          title={portfolioMode ? "포트폴리오 모드 취소" : "포트폴리오 작성 모드"}
          aria-label={portfolioMode ? "포트폴리오 모드 취소" : "포트폴리오 작성 모드"}
          className={cn(
            "h-12 shrink-0 gap-2 rounded-full font-bold shadow-sm transition-all duration-300",
            "w-12 justify-center px-0 2xl:w-auto 2xl:px-6",
            portfolioMode
