...
const SORTING_STRING_INTEGRATION_MODULES = createInteractiveTemplateModules([
  {
      ...
      <CTPContentController
        ...
        overview={
          <ChapterOverview
            ...
            chapterDescription="이 챕터는 참여형 인터랙티브 문제 풀이 흐름으로 구성됩니다."
            guideItems={[
              "문제별로 버튼 조작 순서를 스스로 설계해보세요.",
              "입력 분포를 바꿔가며 반응 차이를 관찰하세요.",
              "수행 로그를 근거로 풀이 전략을 개선하세요.",
            ]}
            items={[
