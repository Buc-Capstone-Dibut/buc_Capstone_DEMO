...
const LIST_TREE_INTEGRATION_MODULES = createInteractiveTemplateModules([
  {
      ...
      <CTPContentController
        ...
        overview={
          <ChapterOverview
            ...
            chapterDescription="구조 선택과 트레이드오프를 참여형 인터랙티브로 체험합니다."
            guideItems={[
              "문제 상황을 가정하고 버튼 조작 시나리오를 설계하세요.",
              "자료구조 선택에 따른 반응 차이를 로그로 확인하세요.",
              "최종적으로 선택 근거를 한 줄로 정리하세요.",
            ]}
            items={[
