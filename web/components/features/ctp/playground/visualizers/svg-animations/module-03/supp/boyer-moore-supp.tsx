    ...
    <svg viewBox="0 0 600 300" className="w-full h-full font-sans bg-slate-50 dark:bg-slate-900 rounded-xl">
      ...
      <g transform="translate(100, 130)">
        ...
        <g transform="translate(90, 60)">
           ...
           <rect x="0" y="0" width="40" height="40" fill={colorTokens.primaryBlue} rx="4" />
           <rect x="45" y="0" width="40" height="40" fill={colorTokens.primaryBlue} rx="4" />
           <rect x="90" y="0" width="40" height="40" fill={colorTokens.primaryBlue} rx="4" />
           <rect x="135" y="0" width="40" height="40" fill={colorTokens.success} rx="4" />
           ...
           <motion.path
              d="M 155 -15 L 20 -15"
              fill="none" stroke={colorTokens.destructive} strokeWidth="4" strokeDasharray="6"
              initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 1.5, repeat: Infinity }}
           />
           <polygon points="15,-15 25,-22 25,-8" fill={colorTokens.destructive} />
           <text x="90" y="-25" fill={colorTokens.destructive} fontSize="14" fontWeight="bold" textAnchor="middle">역순(Right-to-Left) 비교</text>
        </g>
      </g>
    </svg>
  );
  ...
  return (
    <svg viewBox="0 0 600 300" className="w-full h-full font-sans bg-slate-50 dark:bg-slate-900 rounded-xl">
      ...
      <g transform="translate(100, 100)">
        ...
        <motion.rect x="135" y="0" width="40" height="40" fill="none" stroke={colorTokens.destructive} strokeWidth="4" rx="4" />
        <text x="155" y="-10" fill={colorTokens.destructive} fontSize="14" fontWeight="bold" textAnchor="middle">나쁜 문자 'D'</text>

        {/* Pattern Stage 1 */}
        <g transform="translate(0, 60)">
           <text x="-40" y="25" className="fill-slate-700 dark:fill-slate-300" fontSize="16" fontWeight="bold">Pattern</text>
           <rect x="0" y="0" width="40" height="40" fill={colorTokens.primaryBlue} opacity="0.4" rx="4" />
           <rect x="45" y="0" width="40" height="40" fill={colorTokens.primaryBlue} opacity="0.4" rx="4" />
           <rect x="90" y="0" width="40" height="40" fill={colorTokens.primaryBlue} opacity="0.4" rx="4" />
           <rect x="135" y="0" width="40" height="40" fill={colorTokens.destructive} opacity="0.8" rx="4" />
        ...
        <motion.path
           ...
           fill="none" stroke={colorTokens.success} strokeWidth="4" strokeDasharray="4"
           initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ delay: 1, duration: 1, repeat: Infinity, repeatDelay: 1 }}
        />
        <text x="245" y="160" fill={colorTokens.success} fontSize="14" fontWeight="bold" textAnchor="middle">패턴에 'D'가 없으므로 D 다음으로 대폭 점프!</text>
        ...
        >
           ...
           <rect x="45" y="0" width="40" height="40" fill={colorTokens.success} rx="4" />
           <rect x="90" y="0" width="40" height="40" fill={colorTokens.success} rx="4" />
           <rect x="135" y="0" width="40" height="40" fill={colorTokens.success} rx="4" />
      ...
      <g transform="translate(100, 110)">
        ...
        {['S', 'U', 'M', 'M', 'E', 'R', 'T', 'I', 'M', 'E'].map((char, i) => (
          <g key={i} transform={`translate(${i * 40}, 0)`}>
             <rect width="36" height="36" fill="hsl(var(--muted))" className="dark:fill-slate-800" rx="4" />
        ...
        <motion.rect x="120" y="0" width="36" height="36" fill="none" stroke={colorTokens.warning} strokeWidth="4" rx="4" />
        <text x="138" y="-10" fill={colorTokens.warning} fontSize="12" fontWeight="bold" textAnchor="middle">나쁜 문자 'M'</text>
        <text x="338" y="80" fill={colorTokens.success} fontSize="12" fontWeight="bold" textAnchor="middle">'M'을 일치시킴</text>

        {/* Pattern Stage 1 */}
        <g transform="translate(0, 50)">
           <text x="-40" y="25" className="fill-slate-700 dark:fill-slate-300" fontSize="16" fontWeight="bold">Pattern</text>
           <rect x="0" y="0" width="36" height="36" fill={colorTokens.primaryBlue} opacity="0.4" rx="4" />
           <rect x="40" y="0" width="36" height="36" fill={colorTokens.primaryBlue} opacity="0.4" rx="4" />
           <rect x="80" y="0" width="36" height="36" fill={colorTokens.warning} opacity="0.8" rx="4" />
           <rect x="120" y="0" width="36" height="36" fill={colorTokens.destructive} opacity="0.8" rx="4" />
        ...
        <motion.path
           ...
           fill="none" stroke={colorTokens.warning} strokeWidth="3" strokeDasharray="4"
           initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ delay: 1, duration: 1, repeat: Infinity, repeatDelay: 1 }}
        />
        ...
        <motion.g
           ...
           initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 2, duration: 0.5, repeat: Infinity, repeatDelay: 1 }}
        >
           <rect x="0" y="0" width="36" height="36" fill={colorTokens.primaryBlue} rx="4" />
           <rect x="40" y="0" width="36" height="36" fill={colorTokens.primaryBlue} rx="4" />
           <rect x="80" y="0" width="36" height="36" fill={colorTokens.success} rx="4" />
           <rect x="120" y="0" width="36" height="36" fill={colorTokens.primaryBlue} rx="4" />
    ...
    <svg viewBox="0 0 600 300" className="w-full h-full font-sans bg-slate-50 dark:bg-slate-900 rounded-xl">
      ...
      <g transform="translate(100, 110)">
        ...
        <g transform="translate(0, 50)">
           ...
           <rect x="0" y="0" width="36" height="36" fill={colorTokens.primaryBlue} opacity="0.4" rx="4" />
           <rect x="40" y="0" width="36" height="36" fill={colorTokens.primaryBlue} opacity="0.4" rx="4" />
           <rect x="80" y="0" width="36" height="36" fill={colorTokens.destructive} opacity="0.8" rx="4" />
           <rect x="120" y="0" width="36" height="36" fill={colorTokens.success} opacity="1" rx="4" />
           <rect x="160" y="0" width="36" height="36" fill={colorTokens.success} opacity="1" rx="4" />
           <rect x="200" y="0" width="36" height="36" fill={colorTokens.success} opacity="1" rx="4" />
        ...
        <text x="178" y="105" fill={colorTokens.success} fontSize="12" fontWeight="bold" textAnchor="middle">이미 일치한 접미사 "ATO"</text>

        {/* Arrow Match */}
        <motion.path
           d="M 178 115 Q 260 160 340 100"
           fill="none" stroke={colorTokens.success} strokeWidth="3" strokeDasharray="4"
           initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ delay: 1, duration: 1, repeat: Infinity, repeatDelay: 1 }}
        />
        ...
        >
           <rect x="0" y="0" width="36" height="36" fill={colorTokens.primaryBlue} rx="4" />
           <rect x="40" y="0" width="36" height="36" fill={colorTokens.primaryBlue} rx="4" />
           <rect x="80" y="0" width="36" height="36" fill={colorTokens.primaryBlue} rx="4" />
           <rect x="120" y="0" width="36" height="36" fill={colorTokens.success} rx="4" />
           <rect x="160" y="0" width="36" height="36" fill={colorTokens.success} rx="4" />
           <rect x="200" y="0" width="36" height="36" fill={colorTokens.success} rx="4" />
