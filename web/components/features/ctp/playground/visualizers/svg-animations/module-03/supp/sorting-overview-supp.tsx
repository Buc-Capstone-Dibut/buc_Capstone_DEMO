  ...
  return (
    <svg viewBox="0 0 600 300" className="w-full h-full font-mono bg-transparent">
      ...
      <g transform="translate(100, 70)">
        <motion.rect width="40" height="40" rx="8" fill="hsl(var(--card))" stroke="hsl(271 91% 65%)" strokeWidth="2" />
        <text x="20" y="25" fill="hsl(271 91% 65%)" fontSize="18" fontWeight="bold" textAnchor="middle">5</text>
        <text x="20" y="55" fill="hsl(271 91% 65%)" fontSize="12" textAnchor="middle">a</text>
        ...
        <motion.rect x="120" y="0" width="40" height="40" rx="8" fill="hsl(var(--card))" stroke="hsl(24 95% 53%)" strokeWidth="2" />
        <text x="140" y="25" fill="hsl(24 95% 53%)" fontSize="18" fontWeight="bold" textAnchor="middle">5</text>
        <text x="140" y="55" fill="hsl(24 95% 53%)" fontSize="12" textAnchor="middle">b</text>
      ...
      {/* 안정 정렬(Stable) */}
      <text x="150" y="170" fill="hsl(160 84% 39%)" fontSize="16" fontWeight="bold" textAnchor="middle" filter="url(#neon-glow-emerald)">안정 정렬 (O)</text>
      ...
      <g transform="translate(50, 210)">
        ...
        <motion.rect x="100" y="0" width="40" height="40" rx="8" fill="rgba(168, 85, 247, 0.1)" stroke="hsl(271 91% 65%)" strokeWidth="2" />
        <text x="120" y="25" fill="hsl(271 91% 65%)" fontSize="18" fontWeight="bold" textAnchor="middle">5</text>
        <text x="120" y="55" fill="hsl(271 91% 65%)" fontSize="12" textAnchor="middle">a</text>

        <motion.rect x="150" y="0" width="40" height="40" rx="8" fill="rgba(249, 115, 22, 0.1)" stroke="hsl(24 95% 53%)" strokeWidth="2" />
        <text x="170" y="25" fill="hsl(24 95% 53%)" fontSize="18" fontWeight="bold" textAnchor="middle">5</text>
        <text x="170" y="55" fill="hsl(24 95% 53%)" fontSize="12" textAnchor="middle">b</text>
      ...
      {/* 불안정 정렬(Unstable) */}
      <text x="450" y="170" fill="hsl(347 89% 60%)" fontSize="16" fontWeight="bold" textAnchor="middle" filter="url(#neon-glow-rose)">불안정 정렬 (X)</text>
      ...
      <g transform="translate(350, 210)">
        ...
        <motion.rect x="100" y="0" width="40" height="40" rx="8" fill="rgba(249, 115, 22, 0.1)" stroke="hsl(24 95% 53%)" strokeWidth="2" />
        <text x="120" y="25" fill="hsl(24 95% 53%)" fontSize="18" fontWeight="bold" textAnchor="middle">5</text>
        <text x="120" y="55" fill="hsl(24 95% 53%)" fontSize="12" textAnchor="middle">b</text>

        <motion.rect x="150" y="0" width="40" height="40" rx="8" fill="rgba(168, 85, 247, 0.1)" stroke="hsl(271 91% 65%)" strokeWidth="2" />
        <text x="170" y="25" fill="hsl(271 91% 65%)" fontSize="18" fontWeight="bold" textAnchor="middle">5</text>
        <text x="170" y="55" fill="hsl(271 91% 65%)" fontSize="12" textAnchor="middle">a</text>
  ...
  return (
    <svg viewBox="0 0 600 300" className="w-full h-full font-mono bg-transparent">
      ...
      <g transform="translate(150, 60)">
        <text x="0" y="0" fill="hsl(189 94% 43%)" fontSize="18" fontWeight="bold" textAnchor="middle" filter="url(#neon-glow-cyan)">제자리 정렬 (In-place)</text>
        <text x="0" y="20" fill="hsl(var(--muted-foreground))" fontSize="12" textAnchor="middle">추가 메모리 공간 O(1)</text>

        <rect x="-80" y="40" width="160" height="50" rx="8" fill="rgba(6, 182, 212, 0.1)" stroke="hsl(189 94% 43%)" strokeWidth="2" />
        ...
        <path d="M -50 90 A 20 20 0 0 0 -15 90" fill="none" stroke="hsl(24 95% 53%)" strokeWidth="2" strokeDasharray="4" />
        <text x="-32" y="115" fill="hsl(24 95% 53%)" fontSize="12" textAnchor="middle">교환 (Swap)</text>
        <text x="0" y="150" fill="hsl(var(--muted-foreground))" fontSize="12" textAnchor="middle">기존 배열 안에서 요소 위치만 바꿈</text>
      </g>

      {/* 외부(Out-of-place) 정렬 */}
      <g transform="translate(450, 60)">
        <text x="0" y="0" fill="hsl(271 91% 65%)" fontSize="18" fontWeight="bold" textAnchor="middle" filter="url(#neon-glow-rose)">외부 정렬 (Out-of-place)</text>
        ...
        <rect x="-80" y="110" width="160" height="30" rx="4" fill="rgba(168, 85, 247, 0.1)" stroke="hsl(271 91% 65%)" strokeWidth="2" />
...
const TimeComplexitySVG = () => {
  return (
    <svg viewBox="0 0 600 300" className="w-full h-full font-mono bg-transparent">
      ...
      {/* O(N^2) 곡선 */}
      <path d="M 100 260 Q 250 240 300 80" fill="none" stroke="hsl(347 89% 60%)" strokeWidth="3" filter="url(#neon-glow-rose)" />
      <text x="320" y="90" fill="hsl(347 89% 60%)" fontSize="16" fontWeight="bold">O(N²)</text>
      <text x="330" y="110" fill="hsl(var(--muted-foreground))" fontSize="11">선택, 버블, 삽입</text>

      {/* O(N log N) 곡선 */}
      <path d="M 100 260 Q 300 240 480 180" fill="none" stroke="hsl(189 94% 43%)" strokeWidth="3" filter="url(#neon-glow-cyan)" />
      <text x="490" y="185" fill="hsl(189 94% 43%)" fontSize="16" fontWeight="bold">O(N log N)</text>
      <text x="490" y="205" fill="hsl(var(--muted-foreground))" fontSize="11">퀵, 병합, 힙</text>

      {/* O(N) 곡선 */}
      <path d="M 100 260 L 480 230" fill="none" stroke="hsl(160 84% 39%)" strokeWidth="3" filter="url(#neon-glow-emerald)" />
      <text x="490" y="240" fill="hsl(160 84% 39%)" fontSize="16" fontWeight="bold">O(N)</text>
  ...
  return (
    <svg viewBox="0 0 600 300" className="w-full h-full font-mono bg-transparent">
      ...
      <g transform="translate(180, 100)">
        ...
        <text x="200" y="50" fill="hsl(189 94% 43%)" fontSize="28" fontWeight="bold" textAnchor="middle">3</text>
        ...
        <text x="120" y="12" fill="hsl(271 91% 65%)" fontSize="12" fontWeight="bold" textAnchor="middle" filter="url(#neon-glow-rose)">Step 1. 비교</text>
        ...
        <motion.path
          ...
          transition={{ duration: 1, repeat: Infinity, ease: "linear" }}
        />
        <text x="120" y="-35" fill="hsl(160 84% 39%)" fontSize="12" fontWeight="bold" textAnchor="middle" filter="url(#neon-glow-emerald)">Step 2. 교환 (Swap)</text>

        <rect x="60" y="140" width="120" height="60" rx="8" fill="rgba(6, 182, 212, 0.1)" stroke="hsl(189 94% 43%)" strokeWidth="2" />
        <text x="120" y="165" fill="hsl(189 94% 43%)" fontSize="14" fontWeight="bold" textAnchor="middle">임시 변수 (temp)</text>
