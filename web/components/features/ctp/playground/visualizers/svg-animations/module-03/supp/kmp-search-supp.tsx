    ...
    <svg viewBox="0 0 600 300" className="w-full h-full font-sans bg-slate-50 dark:bg-slate-900 rounded-xl">
      ...
      <g transform="translate(100, 150)">
         ...
         <motion.rect
            ...
            fill="none" stroke={colorTokens.primaryBlue} strokeWidth="3" rx="6" strokeDasharray="4"
            initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}
         />
         <text x="65" y="25" fill={colorTokens.primaryBlue} fontSize="14" fontWeight="bold" textAnchor="middle">Prefix "ABA"</text>

         {/* Suffix Highlight */}
         <motion.rect
            x="88" y="-42" width="134" height="44"
            fill="none" stroke={colorTokens.destructive} strokeWidth="3" rx="6" strokeDasharray="4"
            initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.5 }}
         />
         <text x="155" y="45" fill={colorTokens.destructive} fontSize="14" fontWeight="bold" textAnchor="middle">Suffix "ABA"</text>
      </g>
      ...
      <g transform="translate(420, 140)">
         ...
         <text x="0" y="40" fill={colorTokens.success} fontSize="16" fontWeight="bold" textAnchor="middle">최대 3("ABA") 일치!</text>
      </g>
    </svg>
  );
}
...
export function LPSTableSVG() {
  return (
    <svg viewBox="0 0 600 300" className="w-full h-full font-sans bg-slate-50 dark:bg-slate-900 rounded-xl">
      ...
      <g transform="translate(140, 110)">
         ...
         {['A', 'B', 'A', 'B', 'A', 'C'].map((char, i) => (
           <g key={i} transform={`translate(${i * 50}, 0)`}>
              <rect width="45" height="40" fill={colorTokens.primaryBlue} rx="4" />
         ...
         {[0, 0, 1, 2, 3, 0].map((val, i) => (
           <g key={i} transform={`translate(${i * 50}, 60)`}>
              <rect width="45" height="40" fill="none" stroke="hsl(var(--muted-foreground))" strokeWidth="2" rx="4" />
      ...
      />
      <text x="400" y="240" fill={colorTokens.success} fontSize="14" fontWeight="bold">A B A B A 일 때</text>
      <text x="400" y="260" fill={colorTokens.success} fontSize="14" fontWeight="bold">A B A // A B A 일치 (길이 3)</text>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 600 300" className="w-full h-full font-sans bg-slate-50 dark:bg-slate-900 rounded-xl">
      ...
      <g transform="translate(60, 110)">
         ...
         <g transform="translate(0, 50)">
            ...
            <rect width="40" height="40" fill={colorTokens.success} rx="4" />
            ...
            <rect x="180" y="0" width="40" height="40" fill={colorTokens.success} rx="4" />
            <rect x="225" y="0" width="40" height="40" fill={colorTokens.destructive} rx="4" />
         ...
         <text x="235" y="110" fill={colorTokens.destructive} fontSize="12" fontWeight="bold" textAnchor="middle">C ≠ B 불일치!</text>

         {/* Arrow representing jump */}
         <motion.path
            d="M 90 95 Q 135 150 180 95"
            fill="none" stroke={colorTokens.primaryBlue} strokeWidth="3" strokeDasharray="4"
            initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ delay: 1, duration: 1, repeat: Infinity, repeatDelay: 1 }}
         />
         <text x="135" y="165" fill={colorTokens.primaryBlue} fontSize="12" fontWeight="bold" textAnchor="middle">LPS[4] = 3 즉, 앞의 3개("ABA")는 이미 일치함!</text>
         ...
         >
            <rect width="40" height="40" fill={colorTokens.primaryBlue} opacity="0.3" rx="4" />
            <rect x="45" y="0" width="40" height="40" fill={colorTokens.primaryBlue} opacity="0.3" rx="4" />
            <rect x="90" y="0" width="40" height="40" fill={colorTokens.primaryBlue} opacity="0.3" rx="4" />

            <text x="20" y="25" fill={colorTokens.primaryBlue} fontSize="16" fontWeight="bold" textAnchor="middle">A</text>
            <text x="65" y="25" fill={colorTokens.primaryBlue} fontSize="16" fontWeight="bold" textAnchor="middle">B</text>
            <text x="110" y="25" fill={colorTokens.primaryBlue} fontSize="16" fontWeight="bold" textAnchor="middle">A</text>
            <text x="160" y="25" fill={colorTokens.success} fontSize="16" fontWeight="bold" textAnchor="middle">이어서 시작!</text>
         </motion.g>
      </g>
    </svg>
  );
  ...
  return (
    <svg viewBox="0 0 600 300" className="w-full h-full font-sans bg-slate-50 dark:bg-slate-900 rounded-xl">
      ...
      <g transform="translate(80, 140)">
         <rect width="400" height="10" fill="hsl(var(--muted))" className="dark:fill-slate-800" rx="5" />
         ...
         >
            <polygon points="20,-20 30,-5 10,-5" fill={colorTokens.primaryBlue} />
            <text x="20" y="-25" fill={colorTokens.primaryBlue} fontSize="14" fontWeight="bold" textAnchor="middle">i</text>

            <circle cx="20" cy="5" r="8" fill={colorTokens.success} />
         </motion.g>

         <text x="200" y="40" fill={colorTokens.success} fontSize="16" fontWeight="bold" textAnchor="middle">오직 직진만! (백트래킹 없음)</text>
