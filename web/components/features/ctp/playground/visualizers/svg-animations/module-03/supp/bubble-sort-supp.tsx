  ...
  return (
    <svg viewBox="0 0 600 300" className="w-full h-full font-mono bg-transparent">
      ...
      <g transform="translate(150, 100)">
        <rect x="0" y="0" width="80" height="80" rx="12" fill="hsl(var(--card))" stroke={colorTokens.warning} strokeWidth="2" />
        <text x="40" y="50" fill={colorTokens.warning} fontSize="28" fontWeight="bold" textAnchor="middle">8</text>
        <text x="40" y="110" fill="hsl(var(--muted-foreground))" fontSize="14" textAnchor="middle">index: i</text>

        <rect x="100" y="0" width="80" height="80" rx="12" fill="hsl(var(--card))" stroke={colorTokens.info} strokeWidth="2" />
        <text x="140" y="50" fill={colorTokens.info} fontSize="28" fontWeight="bold" textAnchor="middle">3</text>
        ...
        {/* 덮어씌우는 교환 화살표 */}
        <path d="M 40 -15 C 60 -40, 120 -40, 140 -15" fill="none" stroke={colorTokens.destructive} strokeWidth="3" markerEnd="url(#arrow)" strokeDasharray="4" />
        <path d="M 140 95 C 120 120, 60 120, 40 95" fill="none" stroke={colorTokens.destructive} strokeWidth="3" markerEnd="url(#arrow)" strokeDasharray="4" />
        <text x="90" y="-45" fill={colorTokens.destructive} fontSize="14" fontWeight="bold" textAnchor="middle" filter="url(#neon-glow-rose)">크면 자리 바꿈 (Swap)</text>
      </g>
    </svg>
  );
};
  ...
  return (
    <svg viewBox="0 0 600 300" className="w-full h-full font-mono bg-transparent">
      ...
      <g transform="translate(100, 80)">
        {/* State 1 */}
        <rect x="0" y="0" width="30" height="30" rx="4" fill="hsl(var(--card))" stroke={colorTokens.warning} strokeWidth="2" />
        <text x="15" y="20" fill={colorTokens.warning} fontSize="14" fontWeight="bold" textAnchor="middle">9</text>
        ...
        <path d="M 15 35 C 25 50, 45 50, 55 35" fill="none" stroke={colorTokens.warning} strokeWidth="2" markerEnd="url(#arrow)" />
        ...
        <rect x="220" y="40" width="30" height="30" rx="4" fill="hsl(var(--card))" stroke={colorTokens.warning} strokeWidth="2" />
        <text x="235" y="60" fill={colorTokens.warning} fontSize="14" fontWeight="bold" textAnchor="middle">9</text>
        ...
        <path d="M 235 75 C 245 90, 265 90, 275 75" fill="none" stroke={colorTokens.warning} strokeWidth="2" markerEnd="url(#arrow)" />
        ...
        <rect x="80" y="100" width="30" height="30" rx="4" fill="hsl(var(--card))" stroke={colorTokens.warning} strokeWidth="2" />
        <text x="95" y="120" fill={colorTokens.warning} fontSize="14" fontWeight="bold" textAnchor="middle">9</text>
        ...
        <path d="M 95 135 C 105 150, 125 150, 135 135" fill="none" stroke={colorTokens.warning} strokeWidth="2" markerEnd="url(#arrow)" />
  ...
  return (
    <svg viewBox="0 0 600 300" className="w-full h-full font-mono bg-transparent">
      ...
      <g transform="translate(100, 100)">
        ...
        <rect x="50" y="0" width="40" height="40" rx="6" fill="hsl(var(--card))" stroke={colorTokens.primaryHighlight} strokeWidth="2" />
        <text x="70" y="25" fill={colorTokens.primaryHighlight} fontSize="16" textAnchor="middle">3</text>
        <rect x="100" y="0" width="40" height="40" rx="6" fill="hsl(var(--card))" stroke={colorTokens.warning} strokeWidth="2" />
        <text x="120" y="25" fill={colorTokens.warning} fontSize="16" textAnchor="middle">2</text>
        ...
        <path d="M 70 -5 C 90 -20, 100 -20, 120 -5" fill="none" stroke={colorTokens.warning} strokeWidth="2" markerEnd="url(#arrow)" />
        <text x="220" y="25" fill={colorTokens.warning} fontSize="14" fontWeight="bold" filter="url(#neon-glow-orange)">교환 발생 (isSwapped = true)</text>

        {/* Pass 2 - No swap */}
        <text x="-40" y="100" fill="hsl(var(--muted-foreground))" fontSize="14" textAnchor="end">Pass 2</text>
        <rect x="0" y="80" width="40" height="40" rx="6" fill={colorTokens.successDim} stroke={colorTokens.success} strokeWidth="2" />
        <text x="20" y="105" fill={colorTokens.success} fontSize="16" fontWeight="bold" textAnchor="middle">1</text>
        <rect x="50" y="80" width="40" height="40" rx="6" fill={colorTokens.successDim} stroke={colorTokens.success} strokeWidth="2" />
        <text x="70" y="105" fill={colorTokens.success} fontSize="16" fontWeight="bold" textAnchor="middle">2</text>
        <rect x="100" y="80" width="40" height="40" rx="6" fill={colorTokens.successDim} stroke={colorTokens.success} strokeWidth="2" />
        <text x="120" y="105" fill={colorTokens.success} fontSize="16" fontWeight="bold" textAnchor="middle">3</text>
        <rect x="150" y="80" width="40" height="40" rx="6" fill={colorTokens.successDim} stroke={colorTokens.success} strokeWidth="2" />
        <text x="170" y="105" fill={colorTokens.success} fontSize="16" fontWeight="bold" textAnchor="middle">5</text>

        <text x="220" y="105" fill={colorTokens.success} fontSize="14" fontWeight="bold" filter="url(#neon-glow-emerald)">교환 없음! 정렬 완료 선언</text>
        <path d="M 220 120 L 400 120" stroke={colorTokens.success} strokeWidth="2" strokeDasharray="4" />
...
const InefficiencySVG = () => {
  return (
    <svg viewBox="0 0 600 300" className="w-full h-full font-mono bg-transparent">
      ...
      <g transform="translate(100, 80)">
        <rect x="0" y="0" width="30" height="30" rx="4" fill={colorTokens.destructiveTrace} stroke={colorTokens.destructive} strokeWidth="2" />
        <text x="15" y="20" fill={colorTokens.destructive} fontSize="14" fontWeight="bold" textAnchor="middle">5</text>
        <rect x="40" y="0" width="30" height="30" rx="4" fill="hsl(var(--card))" stroke="hsl(var(--border))" />
        ...
        <path d="M 15 35 Q 45 60 75 35" fill="none" stroke={colorTokens.destructive} strokeWidth="2" strokeDasharray="4" markerEnd="url(#arrow)" />
        <path d="M 75 35 Q 105 60 135 35" fill="none" stroke={colorTokens.destructive} strokeWidth="2" strokeDasharray="4" markerEnd="url(#arrow)" />
        <path d="M 135 35 Q 165 60 175 35" fill="none" stroke={colorTokens.destructive} strokeWidth="2" strokeDasharray="4" markerEnd="url(#arrow)" />

        <text x="210" y="20" fill={colorTokens.destructive} fontSize="14" fontWeight="bold" filter="url(#neon-glow-rose)">모든 원소가 n-1번씩 교환되어야 함!</text>
        <text x="210" y="40" fill="hsl(var(--muted-foreground))" fontSize="12">Σ (i=1 to n-1) i = n(n-1)/2 ≈ O(N²)</text>
      </g>

      <g transform="translate(100, 180)">
        <rect x="0" y="0" width="400" height="60" rx="8" fill={colorTokens.infoGhost} stroke={colorTokens.info} strokeWidth="1" />
        <text x="20" y="25" fill={colorTokens.info} fontSize="14" fontWeight="bold">교육용, 소규모 데이터 외에는 사용 불가</text>
