  ...
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(100, 150)">
        <path d="M 40 -40 L 40 10" stroke="hsl(239 84% 67%)" strokeWidth="4" markerEnd="url(#arrow-head)" />
        <text x="40" y="-55" textAnchor="middle" fontSize="16" fontWeight="900" fill="hsl(239 84% 67%)">Base (0x100)</text>
      </g>
      ...
      <g transform="translate(140, 160)" filter="url(#soft-shadow)">
        ...
        <motion.rect x="380" y="15" width="100" height="70" rx="12" fill="hsl(160 84% 39%)" opacity="0.2" stroke="hsl(160 84% 39%)" strokeWidth="3"
          animate={{ opacity: [0, 0.2, 0] }} transition={{ duration: 2.5, repeat: Infinity }} />

        <motion.path d="M 0 0 C 100 -50, 300 -50, 430 0" fill="none" stroke="hsl(160 84% 39%)" strokeWidth="4" strokeDasharray="10 10"
      ...
      <text x="400" y="373" textAnchor="middle" fontSize="16" fontWeight="600" fill="hsl(var(--foreground))">
        주소 = <tspan fill="hsl(239 84% 67%)" fontWeight="800">Base</tspan> + (<tspan fill="hsl(160 84% 39%)" fontWeight="800">Index * 타입 크기</tspan>)
      </text>
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
        ...
        {[10, 20, 30, 40, 50].map((val, i) => {
          ...
          return (
            <g key={i} transform={`translate(${40 + i * 110}, 0)`}>
              ...
              <text x="45" y="45" textAnchor="middle" fontSize="26" fontWeight="900" fill={isTarget ? "hsl(239 84% 67%)" : "hsl(var(--muted-foreground))"}>{val}</text>
      ...
      <motion.g transform="translate(250, 260)" initial={{ opacity: 0, scale: 0.9 }} animate={{ opacity: [0, 1, 1, 0], scale: [0.9, 1, 1, 0.9] }} transition={{ duration: 4, repeat: Infinity, times: [0.2, 0.4, 0.8, 1] }}>
        <text x="-40" y="45" fontSize="20" fontWeight="900" fill="hsl(160 84% 39%)">slice</text>
        {[20, 30, 40].map((val, i) => (
          <g key={i} transform={`translate(${i * 110}, 0)`}>
            <rect width="90" height="70" rx="12" fill="url(#primary-grad)" stroke="hsl(0 0% 100%)" strokeWidth="2" filter="url(#soft-shadow)" />
            <text x="45" y="45" textAnchor="middle" fontSize="26" fontWeight="900" fill="hsl(0 0% 100%)">{val}</text>
          </g>
        ))}
      </motion.g>

      <motion.path d="M 295 190 L 295 240" stroke="hsl(160 84% 39%)" strokeWidth="3" markerEnd="url(#arrow-head-emerald)" strokeDasharray="6 6"
        animate={{ opacity: [0, 1, 0] }} transition={{ duration: 4, repeat: Infinity, times: [0.1, 0.3, 0.4] }} />
      <motion.path d="M 515 190 L 515 240" stroke="hsl(160 84% 39%)" strokeWidth="3" markerEnd="url(#arrow-head-emerald)" strokeDasharray="6 6"
        animate={{ opacity: [0, 1, 0] }} transition={{ duration: 4, repeat: Infinity, times: [0.1, 0.3, 0.4] }} />
      ...
      <text x="400" y="405" textAnchor="middle" fontSize="14" fontWeight="600" fill="hsl(var(--foreground))">
        슬라이싱은 새로운 메모리를 할당받아 데이터를 <tspan fill="hsl(160 84% 39%)" fontWeight="800">복사(Copy)</tspan>합니다.
      </text>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(180, 150)">
        ...
        <g transform="translate(360, 0)">
          <motion.rect width="100" height="80" rx="16" fill="url(#destructive-grad)" stroke="hsl(0 0% 100%)" strokeWidth="3" filter="url(#glow)"
            animate={{ scale: [1, 1.1, 1], opacity: [0.8, 1, 0.8] }} transition={{ duration: 1.5, repeat: Infinity }} />
          <text x="50" y="50" textAnchor="middle" fontSize="32" fontWeight="900" fill="hsl(0 0% 100%)">???</text>
          <text x="50" y="-15" textAnchor="middle" fontSize="16" fontWeight="900" fill="hsl(347 89% 60%)">idx 3</text>
        </g>
      </g>
      ...
      <motion.g transform="translate(150, 320)"
        ...
        <rect width="500" height="60" rx="16" fill="url(#destructive-grad)" filter="url(#glow)" stroke="hsl(0 0% 100%)" strokeWidth="2" />
        <text x="250" y="36" textAnchor="middle" fontSize="20" fontWeight="900" fill="hsl(0 0% 100%)" letterSpacing="1">
  ...
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(150, 150)" filter="url(#soft-shadow)">
        ...
        >
          <path d="M 0 30 L 0 -10" stroke="hsl(347 89% 60%)" strokeWidth="4" markerEnd="url(#arrow-head-rose)" />
          <text x="0" y="45" textAnchor="middle" fontSize="16" fontWeight="900" fill="hsl(347 89% 60%)">i</text>
        </motion.g>

        {/* Boundary Condition */}
        <line x1="440" y1="30" x2="440" y2="120" stroke="hsl(48 96% 53%)" strokeWidth="4" strokeDasharray="8 8" />
        <text x="440" y="20" textAnchor="middle" fontSize="14" fontWeight="800" fill="hsl(48 96% 53%)">N = 5 (경계)</text>
      </g>
      ...
      <text x="400" y="380" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        가장 기초적인 탐색은 <tspan fill="hsl(347 89% 60%)" fontWeight="800">i = 0 부터 i &lt; N 까지</tspan> 하나씩 차례로 방문하는 것입니다.
      </text>
    </svg>
  );
}
