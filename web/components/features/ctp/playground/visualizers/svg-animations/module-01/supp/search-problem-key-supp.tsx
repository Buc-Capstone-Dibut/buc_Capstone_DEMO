  ...
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(80, 100)" filter="url(#soft-shadow)">
        ...
        <text x="100" y="30" textAnchor="middle" fontSize="16" fontWeight="800" fill="hsl(347 89% 60%)">선형 탐색 (O(N))</text>
        ...
        <g transform="translate(40, 80)">
           ...
           <motion.rect x="-10" y="0" width="140" height="36" rx="8" fill="none" stroke="hsl(347 89% 60%)" strokeWidth="3" filter="url(#glow)"
      ...
      <g transform="translate(300, 100)" filter="url(#soft-shadow)">
        <rect width="200" height="240" rx="16" fill="url(#surface-grad)" stroke="hsl(var(--border))" strokeWidth="2" />
        <text x="100" y="30" textAnchor="middle" fontSize="16" fontWeight="800" fill="hsl(239 84% 67%)">이진 탐색 (O(log N))</text>
        ...
        <g transform="translate(40, 80)">
           ...
           <motion.rect x="-10" y="30" width="140" height="40" rx="8" fill="hsl(239 84% 67%)" opacity="0.3" filter="url(#glow)"
              initial={{ scaleY: 0 }} animate={{ scaleY: [0, 1, 0] }} transition={{ duration: 2, repeat: Infinity, delay: 0.5 }} />
           <motion.path d="M -20 50 L 140 50" stroke="hsl(239 84% 67%)" strokeWidth="4" strokeDasharray="10 6"
      ...
      <g transform="translate(520, 100)" filter="url(#soft-shadow)">
        <rect width="200" height="240" rx="16" fill="url(#surface-grad)" stroke="hsl(var(--border))" strokeWidth="2" />
        <text x="100" y="30" textAnchor="middle" fontSize="16" fontWeight="800" fill="hsl(160 84% 39%)">해시 탐색 (O(1))</text>
        <text x="100" y="50" textAnchor="middle" fontSize="12" fontWeight="700" fill="hsl(var(--muted-foreground))">키-값 매핑</text>

        <g transform="translate(30, 100)">
           <rect width="60" height="60" rx="12" fill="url(#primary-grad)" stroke="hsl(0 0% 100%)" strokeWidth="2" />
           <text x="30" y="36" textAnchor="middle" fontSize="14" fontWeight="900" fill="hsl(0 0% 100%)">Key 15</text>

           <path d="M 60 30 C 80 10, 80 50, 100 30" fill="none" stroke="hsl(160 84% 39%)" strokeWidth="3" markerEnd="url(#arrow-head)" />

           <rect x="100" y="0" width="60" height="60" rx="12" fill="url(#emerald-grad)" stroke="hsl(0 0% 100%)" strokeWidth="2" />
           <text x="130" y="36" textAnchor="middle" fontSize="14" fontWeight="900" fill="hsl(0 0% 100%)">Val</text>

           {/* Instense hit animation */}
           <motion.circle cx="130" cy="30" r="35" fill="none" stroke="hsl(160 84% 39%)" strokeWidth="4" filter="url(#glow)"
      ...
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        데이터의 <tspan fill="hsl(239 84% 67%)" fontWeight="800">성질과 제약조건</tspan>에 맞는 최적의 알고리즘을 선택해야 합니다.
      </text>
    </svg>
  );
}
...
function SearchKeyCriteria() {
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      {/* Target Key Scanner */}
      <g transform="translate(300, 100)" filter="url(#soft-shadow)">
        <rect width="200" height="60" rx="30" fill="url(#primary-grad)" stroke="hsl(0 0% 100%)" strokeWidth="3" />
        <text x="100" y="36" textAnchor="middle" fontSize="20" fontWeight="900" fill="hsl(0 0% 100%)" letterSpacing="1">Target = 15</text>
        <motion.ellipse cx="100" cy="30" rx="100" ry="30" fill="none" stroke="hsl(0 0% 100%)" strokeWidth="4" opacity="0.5" filter="url(#glow)"
      ...
      {[5, 12, 15, 27, 8].map((val, i) => {
        ...
        return (
          <motion.path
            ...
            stroke={isMatch ? "hsl(160 84% 39%)" : "hsl(347 89% 60%)"}
            strokeWidth="3"
            strokeDasharray="6 6"
            opacity="0.6"
          ...
          return (
            <g key={`data-${i}`} transform={`translate(${i * 125}, 0)`}>
              <motion.rect width="100" height="100" rx="20"
                ...
                stroke={isMatch ? "hsl(0 0% 100%)" : "hsl(var(--border))"}
                strokeWidth={isMatch ? 4 : 2}
                filter={isMatch ? "url(#soft-shadow)" : ""}
                animate={isMatch ? { y: [0, -10, 0] } : {}}
                transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }} />

              <text x="50" y="25" textAnchor="middle" fontSize="12" fontWeight="700" fill={isMatch ? "hsl(0 0% 100%)" : "hsl(var(--muted-foreground))"}>User Data</text>
              <line x1="20" y1="35" x2="80" y2="35" stroke={isMatch ? "hsl(0 0% 100%)" : "hsl(var(--border))"} strokeWidth="2" opacity="0.5" />
              <text x="50" y="65" textAnchor="middle" fontSize="24" fontWeight="900" fill={isMatch ? "hsl(0 0% 100%)" : "hsl(var(--foreground))"}>{val}</text>
            </g>
          );
        })}
      </g>
      ...
      <rect x="150" y="380" width="500" height="50" rx="25" fill="hsl(var(--muted))" opacity="0.6" stroke="hsl(var(--border))" strokeWidth="1" />
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        복잡한 객체 덩어리에서, 우리는 찾고자 하는 특정 조건인 <tspan fill="hsl(239 84% 67%)" fontWeight="800">키(Key)</tspan>에 집중합니다.
      </text>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(150, 100)" filter="url(#soft-shadow)">
        ...
        <g transform="translate(40, 60)">
           <rect width="40" height="140" fill="hsl(239 84% 67%)" opacity="0.4" rx="8" />
           <text x="20" y="80" textAnchor="middle" fontSize="20" fontWeight="900" fill="hsl(0 0% 100%)">100%</text>
        </g>

        {/* Filter 1 */}
        <motion.path d="M 90 130 L 140 130" stroke="hsl(347 89% 60%)" strokeWidth="4" markerEnd="url(#arrow-head)" initial={{pathLength:0}} animate={{pathLength:1}} transition={{duration:1, delay:1}} />
        <g transform="translate(150, 70)">
           <path d="M 0 0 L 80 0 L 60 40 L 40 120 L 20 120 L 0 40 z" fill="url(#destructive-grad)" />
           <text x="40" y="-10" textAnchor="middle" fontSize="14" fontWeight="800" fill="hsl(347 89% 60%)">나이 &gt; 20</text>
        </g>

        {/* Filtered Data 1 */}
        <motion.path d="M 240 130 L 290 130" stroke="hsl(347 89% 60%)" strokeWidth="4" markerEnd="url(#arrow-head)" initial={{pathLength:0}} animate={{pathLength:1}} transition={{duration:1, delay:1.5}} />
        <g transform="translate(300, 100)">
           <rect width="40" height="60" fill="hsl(239 84% 67%)" opacity="0.7" rx="8" />
           <text x="20" y="40" textAnchor="middle" fontSize="16" fontWeight="900" fill="hsl(0 0% 100%)">40%</text>
        </g>

        {/* Filter 2 */}
        <motion.path d="M 350 130 L 400 130" stroke="hsl(160 84% 39%)" strokeWidth="4" markerEnd="url(#arrow-head)" initial={{pathLength:0}} animate={{pathLength:1}} transition={{duration:1, delay:2}} />
        <g transform="translate(410, 85)">
           <path d="M 0 0 L 60 0 L 45 30 L 30 90 L 15 90 L 0 30 z" fill="url(#emerald-grad)" />
           <text x="30" y="-10" textAnchor="middle" fontSize="14" fontWeight="800" fill="hsl(160 84% 39%)">지역 = '서울'</text>
        </g>

        {/* Final Data */}
        <motion.path d="M 480 130 L 480 160 L 250 160 L 250 190" stroke="hsl(160 84% 39%)" strokeWidth="3" fill="none"
        ...
        <g transform="translate(230, 200)" filter="url(#glow)">
           <rect width="40" height="20" fill="hsl(239 84% 67%)" rx="4" />
           <text x="20" y="15" textAnchor="middle" fontSize="14" fontWeight="900" fill="hsl(0 0% 100%)">5%</text>
        </g>
      </g>
      ...
      <text x="400" y="390" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        복잡한 탐색은 여러 개의 <tspan fill="hsl(347 89% 60%)" fontWeight="800">조건문(필터)</tspan>을 중첩하여 <tspan fill="hsl(239 84% 67%)" fontWeight="800">교집합(AND)</tspan>을 구하는 과정입니다.
      </text>
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(200, 220)">
        ...
        {/* Narrowed Target */}
        <motion.path d="M 0 0 A 120 120 0 0 1 120 0 L 0 0" fill="hsl(160 84% 39%)" opacity="0.4"
           initial={{ opacity: 0 }} animate={{ opacity: [0, 0, 0, 1] }} transition={{ duration: 3, repeat: Infinity, times: [0, 0.5, 0.6, 1] }} />

        <motion.text x="45" y="-40" textAnchor="middle" fontSize="18" fontWeight="900" fill="hsl(160 84% 39%)"
           initial={{ opacity: 0 }} animate={{ opacity: [0, 0, 0, 1] }} transition={{ duration: 3, repeat: Infinity, times: [0, 0.5, 0.6, 1] }}>1/4</motion.text>

        {/* Target Finder */}
        <motion.circle cx="45" cy="-40" r="10" fill="none" stroke="hsl(0 0% 100%)" strokeWidth="3" filter="url(#glow)"
      ...
      <g transform="translate(500, 120)" filter="url(#soft-shadow)">
        ...
        <text x="20" y="70" fontSize="13" fontWeight="800" fill="hsl(347 89% 60%)">1. 기준값 비교</text>
        <text x="20" y="90" fontSize="12" fill="hsl(var(--muted-foreground))">불필요한 절반 버림 (Cut)</text>

        <text x="20" y="130" fontSize="13" fontWeight="800" fill="hsl(160 84% 39%)">2. 범위 재설정</text>
        <text x="20" y="150" fontSize="12" fill="hsl(var(--muted-foreground))">남은 절반에서 재탐색</text>
      </g>

      <rect x="150" y="380" width="500" height="50" rx="25" fill="hsl(var(--muted))" opacity="0.6" stroke="hsl(var(--border))" strokeWidth="1" />
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        고급 탐색 기법은 데이터를 모두 보지 않고 <tspan fill="hsl(347 89% 60%)" fontWeight="800">정답이 없는 공간을 빠르게 버리는</tspan> 전략입니다.
      </text>
    </svg>
  );
}
