  ...
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(350, 140)" filter="url(#soft-shadow)">
        <rect width="100" height="160" rx="24" fill="url(#primary-grad)" stroke="hsl(0 0% 100%)" strokeWidth="2" />
        <text x="50" y="85" textAnchor="middle" fontSize="18" fontWeight="900" fill="hsl(0 0% 100%)" letterSpacing="2">ALGO</text>
        ...
        <motion.rect x="10" y="120" width="80" height="6" rx="3" fill="hsl(0 0% 100%)" opacity="0.4"
           animate={{ width: [10, 80, 10], x: [45, 10, 45] }} transition={{ duration: 1.5, repeat: Infinity, ease: "easeInOut" }} />
        <motion.rect x="10" y="135" width="80" height="6" rx="3" fill="hsl(0 0% 100%)" opacity="0.4"
      ...
      <g transform="translate(560, 160)" filter="url(#soft-shadow)">
        ...
        <text x="70" y="30" textAnchor="middle" fontSize="14" fontWeight="800" fill="hsl(160 84% 39%)">출력 (Output)</text>
      ...
      <text x="400" y="370" textAnchor="middle" fontSize="15" fontFamily="monospace" fontWeight="600" fill="hsl(var(--foreground))">
        <tspan fill="hsl(239 84% 67%)">function</tspan> algorithm(input) =&gt; <tspan fill="hsl(160 84% 39%)">output</tspan>;
      </text>

      {/* Flying Code Elements */}
      <motion.text x="0" y="0" fontSize="20" fontWeight="900" fill="hsl(239 84% 67%)" filter="url(#glow)"
    ...
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(180, 130)">
        ...
        <g transform="translate(190, -20)" filter="url(#soft-shadow)">
           ...
           <text x="70" y="30" textAnchor="middle" fontSize="16" fontWeight="900" fill="hsl(0 0% 100%)">레시피 (Algo)</text>
           <line x1="20" y1="50" x2="80" y2="50" stroke="hsl(0 0% 100%)" strokeWidth="4" strokeLinecap="round" opacity="0.8" />
           <line x1="20" y1="70" x2="110" y2="70" stroke="hsl(0 0% 100%)" strokeWidth="4" strokeLinecap="round" opacity="0.8" />
           <line x1="20" y1="90" x2="60" y2="90" stroke="hsl(0 0% 100%)" strokeWidth="4" strokeLinecap="round" opacity="0.8" />
           <text x="70" y="150" textAnchor="middle" fontSize="14" fontWeight="800" fill="hsl(239 84% 67%)">정확한 순서 파악</text>
        </g>
      ...
      <text x="400" y="370" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        누가 만들어도 동일한 결과를 보장하는 명확한 절차가 바로 <tspan fill="hsl(239 84% 67%)" fontWeight="800">알고리즘</tspan>입니다.
      </text>
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(150, 100)">
        ...
        {/* Growth Curves */}
        <motion.path d="M 50 220 Q 300 220 400 30" fill="none" stroke="hsl(347 89% 60%)" strokeWidth="4" filter="url(#glow)"
           initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 2, ease: "easeInOut", repeat: Infinity, repeatDelay: 1 }} />

        <motion.path d="M 50 220 L 400 100" fill="none" stroke="hsl(217 91% 60%)" strokeWidth="4" filter="url(#glow)"
           initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 2, ease: "easeInOut", repeat: Infinity, repeatDelay: 1 }} />

        <circle cx="200" cy="180" r="8" fill="hsl(217 91% 60%)" />
        <text x="215" y="175" fontSize="14" fontWeight="800" fill="hsl(217 91% 60%)">O(N)</text>

        <circle cx="320" cy="90" r="8" fill="hsl(347 89% 60%)" />
        <text x="335" y="85" fontSize="14" fontWeight="800" fill="hsl(347 89% 60%)">O(N²)</text>
      </g>
      ...
      <text x="400" y="390" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        가파르게 솟구치는 <tspan fill="hsl(347 89% 60%)" fontWeight="800">붉은 곡선</tspan>을 완만한 <tspan fill="hsl(217 91% 60%)" fontWeight="800">파란 선</tspan>으로 눕히는 것이 엔지니어링입니다.
      </text>
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(100, 80)">
        {/* O(1) */}
        <g transform="translate(0, 0)" filter="url(#soft-shadow)">
          <rect width="180" height="220" rx="16" fill="url(#surface-grad)" stroke="hsl(160 84% 39%)" strokeWidth="2" />
          <text x="90" y="30" textAnchor="middle" fontSize="20" fontWeight="900" fill="hsl(160 84% 39%)">O(1)</text>
          <text x="90" y="55" textAnchor="middle" fontSize="12" fontWeight="600" fill="hsl(var(--muted-foreground))">상수 시간</text>

          <rect x="40" y="80" width="100" height="30" rx="6" fill="hsl(160 84% 39%)" opacity="0.2" />
          <rect x="40" y="120" width="100" height="30" rx="6" fill="hsl(160 84% 39%)" opacity="0.2" />
          <rect x="40" y="160" width="100" height="30" rx="6" fill="hsl(160 84% 39%)" opacity="0.2" />
          <line x1="90" y1="80" x2="90" y2="190" stroke="hsl(160 84% 39%)" strokeWidth="4" />

          <text x="90" y="210" textAnchor="middle" fontSize="12" fontWeight="700" fill="hsl(160 84% 39%)">항상 1초</text>
        </g>

        {/* O(N) */}
        <g transform="translate(210, 0)" filter="url(#soft-shadow)">
          <rect width="180" height="220" rx="16" fill="url(#surface-grad)" stroke="hsl(217 91% 60%)" strokeWidth="2" />
          <text x="90" y="30" textAnchor="middle" fontSize="20" fontWeight="900" fill="hsl(217 91% 60%)">O(N)</text>
          <text x="90" y="55" textAnchor="middle" fontSize="12" fontWeight="600" fill="hsl(var(--muted-foreground))">선형 시간</text>

          <motion.path d="M 40 180 L 140 80" stroke="hsl(217 91% 60%)" strokeWidth="4" fill="none"
              initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 1.5, repeat: Infinity, repeatDelay: 1 }} />

          <text x="90" y="210" textAnchor="middle" fontSize="12" fontWeight="700" fill="hsl(217 91% 60%)">데이터 비례 (10초)</text>
        </g>

        {/* O(N^2) */}
        <g transform="translate(420, 0)" filter="url(#soft-shadow)">
          <rect width="180" height="220" rx="16" fill="url(#surface-grad)" stroke="hsl(347 89% 60%)" strokeWidth="2" />
          <text x="90" y="30" textAnchor="middle" fontSize="20" fontWeight="900" fill="hsl(347 89% 60%)">O(N²)</text>
          <text x="90" y="55" textAnchor="middle" fontSize="12" fontWeight="600" fill="hsl(var(--muted-foreground))">제곱 시간</text>

          <motion.path d="M 40 180 Q 120 180 140 80" stroke="hsl(347 89% 60%)" strokeWidth="4" fill="none"
              initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 1.5, repeat: Infinity, repeatDelay: 1 }} />

          <text x="90" y="210" textAnchor="middle" fontSize="12" fontWeight="700" fill="hsl(347 89% 60%)">기하급수 폭발 (100초)</text>
        </g>
      </g>
      ...
      <text x="400" y="365" textAnchor="middle" fontSize="14" fontWeight="600" fill="hsl(var(--foreground))">
        N = 10만일 때, <tspan fill="hsl(160 84% 39%)" fontWeight="800">O(1)</tspan>은 즉시 완료되지만
      </text>
      <text x="400" y="385" textAnchor="middle" fontSize="14" fontWeight="600" fill="hsl(var(--foreground))">
        <tspan fill="hsl(347 89% 60%)" fontWeight="800">O(N²)</tspan>은 무려 100억 번의 연산으로 서버를 정지시킬 수 있습니다.
      </text>
    </svg>
  );
}
