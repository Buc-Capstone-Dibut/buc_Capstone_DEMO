  ...
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(290, 150)" filter="url(#soft-shadow)">
        ...
        <text x="80" y="92" textAnchor="middle" fontSize="12" fontWeight="800" fill="hsl(239 84% 67%)">Condition</text>
      </g>
      ...
      <g transform="translate(615, 90)" filter="url(#soft-shadow)">
        ...
        <text x="70" y="46" textAnchor="middle" fontSize="20" fontWeight="900" fill="hsl(160 84% 39%)">합격 (Pass)</text>
        <circle cx="20" cy="20" r="10" fill="hsl(160 84% 39%)" filter="url(#glow)" />
        <path d="M 15 20 L 19 24 L 25 16" fill="none" stroke="hsl(0 0% 100%)" strokeWidth="2.5" strokeLinecap="round" />
      </g>
      ...
      <motion.circle r="8" fill="hsl(0 0% 100%)" filter="url(#glow)"
        animate={{
      ...
      />
      <motion.circle r="12" fill="none" stroke="hsl(160 84% 39%)" strokeWidth="2" filter="url(#glow)"
        animate={{
           cx: [50, 200, 360, 460, 500, 600],
           cy: [220, 220, 220, 220, 130, 130],
      ...
      <g transform="translate(250, 340)">
        ...
        <text x="150" y="32" textAnchor="middle" fontSize="14" fontFamily="monospace" fontWeight="600" fill="hsl(var(--foreground))">
          <tspan fill="hsl(239 84% 67%)">if</tspan> (점수 &gt;= 80) {"{"} <tspan fill="hsl(160 84% 39%)">return "합격";</tspan> {"}"}
        </text>
        <text x="150" y="52" textAnchor="middle" fontSize="14" fontFamily="monospace" fontWeight="600" fill="hsl(var(--foreground))">
          <tspan fill="hsl(239 84% 67%)">else</tspan> {"{"} <tspan fill="hsl(var(--muted-foreground))">return "불합격";</tspan> {"}"}
        </text>
      </g>
    </svg>
  );
  ...
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(180, 135)" filter="url(#soft-shadow)">
        ...
        <rect x="40" y="-15" width="100" height="30" rx="15" fill="hsl(239 84% 67%)" />
        <text x="90" y="4" textAnchor="middle" fontSize="13" fontWeight="bold" fill="hsl(0 0% 100%)" letterSpacing="1">누적 변수 (sum)</text>
      ...
      <g transform="translate(560, 225)">
        ...
        <text x="0" y="20" textAnchor="middle" fontSize="24" fontWeight="900" fill="hsl(160 84% 39%)">반복</text>
      </g>
      ...
      >
        <rect x="-30" y="-20" width="60" height="40" rx="10" fill="hsl(0 0% 100%)" filter="url(#glow)" stroke="hsl(239 84% 67%)" strokeWidth="2" />
        <text x="0" y="5" textAnchor="middle" fontSize="16" fontWeight="800" fill="hsl(239 84% 67%)">+arr[i]</text>
      </motion.g>
      ...
      <g transform="translate(150, 370)">
         ...
         <text x="250" y="30" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
           반복문은 동일한 로직을 수행하며, 주로 <tspan fill="hsl(239 84% 67%)" fontWeight="800">합계/결과를 누적</tspan>합니다.
         </text>
      </g>
    </svg>
  );
...
function CombiningPatterns() {
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <rect x="100" y="85" width="180" height="30" rx="15" fill="hsl(160 84% 39%)" />
      <text x="190" y="105" textAnchor="middle" fontSize="14" fontWeight="800" fill="hsl(0 0% 100%)">for: 매 원소마다 반복</text>
      ...
      <g transform="translate(290, 150)" filter="url(#soft-shadow)">
        <polygon points="100,0 200,70 100,140 0,70" fill="url(#surface-grad)" stroke="hsl(160 84% 39%)" strokeWidth="4" />
        <rect x="60" y="30" width="80" height="24" rx="12" fill="hsl(160 84% 39%)" opacity="0.1" />
        <text x="100" y="46" textAnchor="middle" fontSize="12" fontWeight="800" fill="hsl(160 84% 39%)">IF 필터링</text>
      ...
      <g transform="translate(620, 180)" filter="url(#soft-shadow)">
        ...
        <text x="50" y="46" textAnchor="middle" fontSize="18" fontWeight="900" fill="hsl(0 0% 100%)">동작 실행</text>
      </g>

      {/* Animated Flow Packet */}
      <motion.circle r="10" fill="hsl(0 0% 100%)" filter="url(#glow)"
        animate={{
  ...
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(150, 100)" filter="url(#soft-shadow)">
        ...
        {/* Mac OS window dots */}
        <circle cx="20" cy="20" r="6" fill="hsl(347 89% 60%)" />
        <circle cx="40" cy="20" r="6" fill="hsl(48 96% 53%)" />
        <circle cx="60" cy="20" r="6" fill="hsl(160 84% 39%)" />
        ...
        <g transform="translate(40, 70)" fontSize="16" fontFamily="monospace" fontWeight="600" fill="hsl(var(--foreground))">
          {/* For loop */}
          <text x="0" y="20"><tspan fill="hsl(239 84% 67%)">for</tspan> (<tspan fill="hsl(239 84% 67%)">let</tspan> i = <tspan fill="hsl(38 92% 50%)">0</tspan>; i &lt; arr.length; i++) {'{'}</text>

          {/* Highlight for loop block */}
          <rect x="10" y="28" width="410" height="150" fill="none" stroke="hsl(239 84% 67%)" strokeWidth="2" strokeDasharray="4 4" rx="8" opacity="0.4" />
          <text x="425" y="50" fontSize="12" fill="hsl(239 84% 67%)" opacity="0.8">Outer Loop</text>

          {/* If condition */}
          <text x="40" y="60"><tspan fill="hsl(330 81% 60%)">if</tspan> (arr[i] === <tspan fill="hsl(38 92% 50%)">target</tspan>) {'{'}</text>

          {/* Highlight if block */}
          <rect x="50" y="68" width="350" height="70" fill="none" stroke="hsl(330 81% 60%)" strokeWidth="2" strokeDasharray="4 4" rx="8" opacity="0.4" />
          <text x="405" y="90" fontSize="12" fill="hsl(330 81% 60%)" opacity="0.8">Inner Filter</text>

          {/* Action */}
          <text x="80" y="100">console.<tspan fill="hsl(217 91% 60%)">log</tspan>(<tspan fill="hsl(160 84% 39%)">"Found at "</tspan> + i);</text>
          <text x="80" y="125"><tspan fill="hsl(347 89% 60%)">break</tspan>; <tspan fill="hsl(var(--muted-foreground))">// 조기 종료</tspan></text>
      ...
      <text x="400" y="405" textAnchor="middle" fontSize="14" fontWeight="600" fill="hsl(var(--foreground))">
        가장 강력하게 쓰이는 <tspan fill="hsl(239 84% 67%)" fontWeight="800">탐색(루프)</tspan>과 <tspan fill="hsl(330 81% 60%)" fontWeight="800">필터링(분기)</tspan>의 조합입니다.
      </text>
    </svg>
  );
}
