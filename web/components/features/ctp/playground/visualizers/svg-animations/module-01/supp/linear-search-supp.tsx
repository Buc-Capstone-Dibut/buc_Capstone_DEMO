            ...
            <g key={i} transform={`translate(${i * 60}, 10)`}>
              ...
              {isTarget ? (
                <motion.g animate={{ opacity: [0, 1, 0, 0, 0, 0] }} transition={{ duration: 6, repeat: Infinity, times: [0, 0.1, 0.4, 0.6, 0.8, 1], delay: (i * 0.8) }}>
                  <circle cx="25" cy="25" r="30" fill="none" stroke="hsl(var(--emerald-500, hsl(160 84% 39%)))" strokeWidth="3" />
                  <text x="25" y="-10" textAnchor="middle" fontSize="12" fontWeight="bold" fill="hsl(var(--emerald-500, hsl(160 84% 39%)))">Found!</text>
                </motion.g>
              ) : (
  ...
  return (
    <svg viewBox="0 0 600 300" className="w-full h-full" style={{ fontFamily: "var(--font-sans), system-ui, sans-serif" }}>
      ...
      <g transform="translate(40, 130)">
        <text x="260" y="-10" textAnchor="middle" fontSize="12" fontWeight="bold" fill="hsl(var(--emerald-500, hsl(160 84% 39%)))">Sentinel Search (1 Check per loop)</text>
        <rect x="0" y="0" width="520" height="90" rx="8" fill="hsl(var(--emerald-500, hsl(160 84% 39%))/0.1)" stroke="hsl(var(--emerald-500, hsl(160 84% 39%)))" strokeWidth="2" />
        ...
        <text x="20" y="45" fontSize="12" fontFamily="monospace" fill="hsl(var(--foreground))">
          <tspan fill="hsl(var(--primary))">while</tspan> (arr[i] != target <tspan fill="hsl(var(--emerald-500, hsl(160 84% 39%)))" fontWeight="bold">/* Check 1 (Only!) */</tspan>) {'{'} i++; {'}'}
        </text>
        ...
        <g transform="translate(360, 40)">
          ...
          <rect x="70" y="0" width="30" height="20" fill="hsl(var(--emerald-500, hsl(160 84% 39%))/0.2)" stroke="hsl(var(--emerald-500, hsl(160 84% 39%)))" />
          <text x="85" y="14" textAnchor="middle" fontSize="10" fill="hsl(var(--emerald-500, hsl(160 84% 39%)))">Sent</text>
        </g>
      </g>
  ...
  return (
    <svg viewBox="0 0 600 300" className="w-full h-full" style={{ fontFamily: "var(--font-sans), system-ui, sans-serif" }}>
      ...
      <g transform="translate(100, 70)">
        ...
        <rect x="260" y="0" width="140" height="30" fill="hsl(var(--emerald-500, hsl(160 84% 39%))/0.1)" rx="4" />
        <text x="330" y="20" textAnchor="middle" fontSize="12" fontWeight="bold" fill="hsl(var(--emerald-500, hsl(160 84% 39%)))">Binary Search O(log N)</text>
        ...
        <rect x="260" y="45" width="5" height="20" fill="hsl(var(--emerald-500, hsl(160 84% 39%))/0.3)" rx="2" />
        <text x="275" y="60" fontSize="12" fill="hsl(var(--emerald-500, hsl(160 84% 39%)))">Max 4 checks</text>
        ...
        <rect x="260" y="85" width="15" height="20" fill="hsl(var(--emerald-500, hsl(160 84% 39%))/0.5)" rx="2" />
        <text x="285" y="100" fontSize="12" fill="hsl(var(--emerald-500, hsl(160 84% 39%)))">Max 10 checks</text>
        ...
        <rect x="260" y="125" width="30" height="20" fill="hsl(var(--emerald-500, hsl(160 84% 39%)))" rx="2" />
        <text x="300" y="140" fontSize="12" fontWeight="bold" fill="hsl(var(--emerald-500, hsl(160 84% 39%)))">Max 20 checks!</text>
      </g>
    </svg>
  );
}
