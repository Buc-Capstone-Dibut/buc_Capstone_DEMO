  ...
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(400, 100)">
         {/* Edges */}
         <path d="M 0 20 L -200 100" stroke="hsl(239 84% 67%)" strokeWidth="3" opacity="0.4" />
         <path d="M 0 20 L 0 100" stroke="hsl(239 84% 67%)" strokeWidth="3" opacity="0.4" />
         <path d="M 0 20 L 200 100" stroke="hsl(239 84% 67%)" strokeWidth="3" opacity="0.4" />

         <path d="M -200 120 L -280 200" stroke="hsl(239 84% 67%)" strokeWidth="3" opacity="0.4" />
         <path d="M -200 120 L -120 200" stroke="hsl(239 84% 67%)" strokeWidth="3" opacity="0.4" />

         {/* Root */}
         <circle cx="0" cy="10" r="25" fill="url(#surface-grad)" stroke="hsl(239 84% 67%)" strokeWidth="2" filter="url(#soft-shadow)" />
         <text x="0" y="15" textAnchor="middle" fontSize="14" fontWeight="bold" fill="hsl(var(--foreground))">시작</text>

         {/* Level 1 (Row 1) */}
         <g transform="translate(-200, 110)">
            <circle cx="0" cy="0" r="25" fill="hsl(239 84% 67%)" filter="url(#glow)" />
            <text x="0" y="5" textAnchor="middle" fontSize="14" fontWeight="bold" fill="hsl(0 0% 100%)">(1,1)</text>
         </g>
         <g transform="translate(0, 110)">
            <circle cx="0" cy="0" r="25" fill="url(#surface-grad)" stroke="hsl(239 84% 67%)" strokeWidth="2" />
         ...
         <g transform="translate(-280, 210)">
            <motion.circle cx="0" cy="0" r="25" fill="hsl(347 89% 60%)" filter="url(#glow)"
               animate={{ scale: [1, 1.2, 1] }} transition={{ duration: 1, repeat: Infinity }} />
            <text x="0" y="5" textAnchor="middle" fontSize="14" fontWeight="bold" fill="hsl(0 0% 100%)">(2,1)</text>
         </g>
         <g transform="translate(-120, 210)">
            <motion.circle cx="0" cy="0" r="25" fill="hsl(347 89% 60%)" filter="url(#glow)"
               animate={{ scale: [1, 1.2, 1] }} transition={{ duration: 1, repeat: Infinity, delay: 0.5 }} />
            <text x="0" y="5" textAnchor="middle" fontSize="14" fontWeight="bold" fill="hsl(0 0% 100%)">(2,2)</text>
         </g>

         {/* Crosses for Pruning */}
         <motion.path d="M -290 200 L -270 220 M -270 200 L -290 220" stroke="hsl(0 0% 100%)" strokeWidth="4"
            animate={{ opacity: [0, 1, 0] }} transition={{ duration: 2, repeat: Infinity, delay: 1 }} />
         <motion.path d="M -130 200 L -110 220 M -110 200 L -130 220" stroke="hsl(0 0% 100%)" strokeWidth="4"
      ...
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        모든 가능한 배치를 <tspan fill="hsl(239 84% 67%)" fontWeight="800">거대한 트리 구조</tspan>로 생각하고 루트부터 탐색해 내려갑니다.
      </text>
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(150, 100)">
         ...
         {/* Queen 1 */}
         <circle cx="25" cy="25" r="15" fill="hsl(239 84% 67%)" filter="url(#glow)" />
         <text x="25" y="30" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(0 0% 100%)">Q</text>

         {/* Attack Lines from Q1 */}
         <motion.path d="M 25 50 L 25 200" stroke="hsl(347 89% 60%)" strokeWidth="4" strokeDasharray="4 4" animate={{ opacity: [0, 0.5, 0] }} transition={{ duration: 2, repeat: Infinity }} />
         <motion.path d="M 50 50 L 200 200" stroke="hsl(347 89% 60%)" strokeWidth="4" strokeDasharray="4 4" animate={{ opacity: [0, 0.5, 0] }} transition={{ duration: 2, repeat: Infinity }} />
      ...
      <g transform="translate(420, 130)">
         ...
         <motion.g transform="translate(0, 20)"
            ...
            <circle cx="15" cy="15" r="15" fill="hsl(347 89% 60%)" opacity="0.6" />
            <path d="M 5 5 L 25 25 M 25 5 L 5 25" stroke="hsl(0 0% 100%)" strokeWidth="3" />
            <text x="40" y="20" fontSize="13" fontWeight="bold" fill="hsl(347 89% 60%)">(2,1) Pruning!</text>
         </motion.g>
         ...
         <motion.g transform="translate(0, 65)"
            ...
            <circle cx="15" cy="15" r="15" fill="hsl(347 89% 60%)" opacity="0.6" />
            <path d="M 5 5 L 25 25 M 25 5 L 5 25" stroke="hsl(0 0% 100%)" strokeWidth="3" />
            <text x="40" y="20" fontSize="13" fontWeight="bold" fill="hsl(347 89% 60%)">(2,2) Pruning!</text>
         </motion.g>
         ...
         <motion.g transform="translate(0, 110)"
            ...
            <circle cx="15" cy="15" r="17" fill="hsl(160 84% 39%)" filter="url(#glow)" />
            <text x="15" y="20" textAnchor="middle" fontSize="14" fontWeight="bold" fill="hsl(0 0% 100%)">Q</text>
            <text x="40" y="20" fontSize="13" fontWeight="bold" fill="hsl(160 84% 39%)">(2,3) 유망함!</text>
         </motion.g>
      </g>

      <rect x="150" y="380" width="500" height="50" rx="25" fill="hsl(var(--muted))" opacity="0.6" stroke="hsl(var(--border))" strokeWidth="1" />
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        틀린 길임을 감지하면 <tspan fill="hsl(347 89% 60%)" fontWeight="800">더 이상 깊이 탐색하지 않고(Pruning)</tspan> 즉시 포기합니다.
      </text>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(150, 100)" filter="url(#soft-shadow)">
         ...
         <g transform="translate(50, 40)">
            <text x="0" y="0" fontSize="18" fontWeight="bold" fill="hsl(239 84% 67%)">1. 상태 변경 (배치)</text>
            <rect x="0" y="10" width="400" height="30" rx="4" fill="hsl(239 84% 67%)" opacity="0.2" />
            <text x="10" y="30" fontSize="14" fill="hsl(var(--foreground))" fontFamily="monospace">board[row] = col;</text>
         </g>

         <g transform="translate(50, 90)">
            <text x="0" y="0" fontSize="18" fontWeight="bold" fill="hsl(160 84% 39%)">2. 재귀 호출 (다음 단계 진입)</text>
            <rect x="0" y="10" width="400" height="30" rx="4" fill="hsl(160 84% 39%)" opacity="0.2" />
         ...
         <motion.g transform="translate(50, 140)" animate={{ x: [0, 5, 0] }} transition={{ duration: 1.5, repeat: Infinity }}>
            <text x="0" y="0" fontSize="18" fontWeight="bold" fill="hsl(347 89% 60%)">3. 상태 복구 (Backtrack)</text>
            <rect x="0" y="10" width="400" height="30" rx="4" fill="hsl(347 89% 60%)" opacity="0.2" />
            <text x="10" y="30" fontSize="14" fill="hsl(var(--foreground))" fontFamily="monospace">board[row] = -1; // 또는 덮어쓰기로 생략</text>
            <path d="M 420 25 C 450 25 450 -25 420 -25" fill="none" stroke="hsl(347 89% 60%)" strokeWidth="3" markerEnd="url(#arrow-head)" />
         </motion.g>
      ...
      <rect x="150" y="380" width="500" height="50" rx="25" fill="hsl(var(--muted))" opacity="0.6" stroke="hsl(var(--border))" strokeWidth="1" />
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        다음 형제 노드 탐색을 위해 <tspan fill="hsl(347 89% 60%)" fontWeight="800">이전 상태로 되돌리는(Undo)</tspan> 것이 핵심 패턴입니다.
      </text>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(100, 100)">
         ...
         <g transform="translate(0, 0)">
            ...
            {/* Placed Queen at (1, 1) */}
            <circle cx="60" cy="60" r="14" fill="hsl(239 84% 67%)" filter="url(#glow)" />
            <text x="60" y="65" textAnchor="middle" fontSize="14" fontWeight="bold" fill="hsl(0 0% 100%)">Q</text>
            ...
            <motion.circle cx="140" cy="140" r="14" fill="hsl(160 84% 39%)" opacity="0.6"
               animate={{ scale: [1, 1.2, 1] }} transition={{ duration: 1.5, repeat: Infinity }} />
            <text x="140" y="145" textAnchor="middle" fontSize="14" fontWeight="bold" fill="hsl(0 0% 100%)">?</text>
            ...
            {/* Line connecting */}
            <motion.path d="M 60 60 L 140 140" stroke="hsl(347 89% 60%)" strokeWidth="4" strokeDasharray="6 6"
         ...
         <g transform="translate(250, 40)" filter="url(#soft-shadow)">
            <rect width="320" height="150" rx="16" fill="url(#surface-grad)" stroke="hsl(239 84% 67%)" strokeWidth="2" />

            <text x="20" y="30" fontSize="16" fontWeight="bold" fill="hsl(239 84% 67%)">대각선 위협 판별식</text>

            <rect x="20" y="45" width="280" height="40" rx="6" fill="hsl(347 89% 60%)" opacity="0.1" />
            ...
            <text x="20" y="130" fontSize="14" fill="hsl(var(--muted-foreground))">
               열의 차이의 절댓값이 같다면 <tspan fill="hsl(347 89% 60%)" fontWeight="bold">대각선상에 존재</tspan>
            </text>
         </g>
      </g>
      ...
      <rect x="150" y="380" width="500" height="50" rx="25" fill="hsl(var(--muted))" opacity="0.6" stroke="hsl(var(--border))" strokeWidth="1" />
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        기울기가 1 또는 -1인 직선 방정식의 원리를 통해 <tspan fill="hsl(239 84% 67%)" fontWeight="800">O(1) 수식 하나로 판별</tspan>합니다.
      </text>
    </svg>
  );
}
