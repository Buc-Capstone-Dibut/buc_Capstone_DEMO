    ...
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(150, 250)">
         ...
         <g transform="translate(80, -150)">
            ...
            <rect x="-40" y="100" width="80" height="20" rx="6" fill="hsl(239 84% 67%)" />
            <rect x="-60" y="125" width="120" height="20" rx="6" fill="hsl(239 84% 67%)" />

            <rect x="-60" y="170" width="120" height="30" rx="6" fill="url(#surface-grad)" stroke="hsl(239 84% 67%)" strokeWidth="2" />
            <text x="0" y="190" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(239 84% 67%)">A (시작)</text>
         </g>
         ...
         <g transform="translate(420, -150)">
            ...
            <rect x="-60" y="170" width="120" height="30" rx="6" fill="url(#surface-grad)" stroke="hsl(160 84% 39%)" strokeWidth="2" />
            <text x="0" y="190" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(160 84% 39%)">C (목표)</text>

             <motion.path d="M -340 70 L -340 -80 L 0 -80 L 0 10" fill="none" stroke="hsl(160 84% 39%)" strokeWidth="4" markerEnd="url(#arrow-head-emerald)"
               animate={{ opacity: [0, 1, 0] }} transition={{ duration: 3, repeat: Infinity, ease: "easeInOut", delay: 1.5 }} />
             <motion.rect x="-20" y="15" width="40" height="20" rx="6" fill="hsl(160 84% 39%)" opacity="0.6" animate={{ opacity: [0, 1, 0] }} transition={{ duration: 3, repeat: Infinity, ease: "easeInOut", delay: 1.5 }} />
         </g>
      </g>
      ...
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        재귀 호출 시마다 <tspan fill="hsl(239 84% 67%)" fontWeight="800">A, B, C 세 기둥의 역할(파라미터)</tspan>이 동적으로 순환하며 바뀝니다.
      </text>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(100, 120)">
         ...
         <g transform="translate(0, 0)" filter="url(#soft-shadow)">
            ...
            <text x="90" y="35" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(239 84% 67%)">1. 밑판 빼고 다 치우기</text>

            {/* Visuals */}
            <g transform="translate(90, 80)">
               <rect x="-40" y="80" width="80" height="15" rx="4" fill="hsl(239 84% 67%)" opacity="0.3" />{/* original base */}

               {/* moving group */}
               <motion.g animate={{ x: [0, 0, 40], y: [0, -30, 40] }} transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}>
                  <rect x="-20" y="40" width="40" height="15" rx="4" fill="hsl(347 89% 60%)" />
                  <rect x="-30" y="60" width="60" height="15" rx="4" fill="hsl(347 89% 60%)" />
                  <path d="M 0 -10 A 30 50 0 0 1 40 10" fill="none" stroke="hsl(347 89% 60%)" strokeWidth="2" markerEnd="url(#arrow-head)" strokeDasharray="4 4" />
               </motion.g>
            </g>
         ...
         <g transform="translate(210, 0)" filter="url(#soft-shadow)">
            <rect width="180" height="220" rx="16" fill="url(#surface-grad)" stroke={ "hsl(var(--border))" } strokeWidth="2" />
            <text x="90" y="35" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(160 84% 39%)">2. 밑판을 목적지로</text>

            <g transform="translate(90, 80)">
               {/* other piled left */}
               <rect x="25" y="80" width="60" height="15" rx="4" fill="hsl(347 89% 60%)" opacity="0.3" />
               <rect x="35" y="60" width="40" height="15" rx="4" fill="hsl(347 89% 60%)" opacity="0.3" />

               {/* moving base */}
               <motion.g animate={{ x: [0, 0, -50], y: [0, -40, 20] }} transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}>
                  <rect x="-40" y="80" width="80" height="15" rx="4" fill="hsl(239 84% 67%)" />
                  <path d="M -40 70 A 40 50 0 0 0 -50 90" fill="none" stroke="hsl(239 84% 67%)" strokeWidth="2" markerEnd="url(#arrow-head)" strokeDasharray="4 4" />
               </motion.g>
            </g>
         ...
         <g transform="translate(420, 0)" filter="url(#soft-shadow)">
            <rect width="180" height="220" rx="16" fill="url(#surface-grad)" stroke={ "hsl(var(--border))" } strokeWidth="2" />
            <text x="90" y="35" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(271 91% 65%)">3. 치웠던 N-1 다시 덮기</text>

            <g transform="translate(90, 80)">
               <rect x="-80" y="100" width="80" height="15" rx="4" fill="hsl(239 84% 67%)" opacity="0.8" />

               {/* moving group */}
               <motion.g animate={{ x: [40, 40, -40], y: [30, -30, 20] }} transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}>
                  <rect x="-20" y="40" width="40" height="15" rx="4" fill="hsl(347 89% 60%)" />
                  <rect x="-30" y="60" width="60" height="15" rx="4" fill="hsl(347 89% 60%)" />
                  <path d="M -30 30 A 30 30 0 0 0 -60 50" fill="none" stroke="hsl(347 89% 60%)" strokeWidth="2" markerEnd="url(#arrow-head)" strokeDasharray="4 4" />
               </motion.g>
            </g>
      ...
      <rect x="150" y="380" width="500" height="50" rx="25" fill="hsl(var(--muted))" opacity="0.6" stroke="hsl(var(--border))" strokeWidth="1" />
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        복잡해 보이지만 사실상 <tspan fill="hsl(347 89% 60%)" fontWeight="800">단 3개의 논리적 블록</tspan>으로 완벽히 분할되는 문제입니다.
      </text>
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(450, 100)" filter="url(#soft-shadow)">
         ...
         <text x="125" y="30" textAnchor="middle" fontSize="16" fontWeight="900" fill="hsl(239 84% 67%)">점화식 도출</text>

         <text x="125" y="70" textAnchor="middle" fontSize="18" fontWeight="bold" fill="hsl(var(--foreground))" fontFamily="monospace">
            T(N) = <tspan fill="hsl(347 89% 60%)">2</tspan> * T(N-1) + <tspan fill="hsl(160 84% 39%)">1</tspan>
         </text>

         <circle cx="70" cy="100" r="4" fill="hsl(347 89% 60%)" />
         <text x="80" y="105" fontSize="12" fill="hsl(var(--muted-foreground))">N-1 덩어리 이동 (2번)</text>

         <circle cx="70" cy="120" r="4" fill="hsl(160 84% 39%)" />
         <text x="80" y="125" fontSize="12" fill="hsl(var(--muted-foreground))">제일 큰 N 밑판 이동 (1번)</text>
      </g>

      <rect x="150" y="380" width="500" height="50" rx="25" fill="hsl(var(--muted))" opacity="0.6" stroke="hsl(var(--border))" strokeWidth="1" />
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        각 단계마다 횟수가 정확히 2배+1 씩 늘어나는 완벽한 <tspan fill="hsl(347 89% 60%)" fontWeight="800">지수 시간(Exponential Time)</tspan> 복잡도입니다.
      </text>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(100, 100)" filter="url(#soft-shadow)">
         ...
         <g transform="translate(60, 40)">
            <rect width="40" height="40" rx="6" fill="hsl(160 84% 39%)" />
            <text x="20" y="25" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(0 0% 100%)">A</text>
            <text x="60" y="25" fontSize="16" fontWeight="bold" fill="hsl(var(--foreground))">1을 C로</text>
         </g>
         <g transform="translate(240, 40)">
            <rect width="40" height="40" rx="6" fill="hsl(160 84% 39%)" />
            <text x="20" y="25" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(0 0% 100%)">B</text>
            <text x="60" y="25" fontSize="16" fontWeight="bold" fill="hsl(var(--foreground))">2를 B로</text>
         </g>
         <g transform="translate(420, 40)">
            <rect width="40" height="40" rx="6" fill="hsl(160 84% 39%)" />
            <text x="20" y="25" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(0 0% 100%)">C</text>
            <text x="60" y="25" fontSize="16" fontWeight="bold" fill="hsl(var(--foreground))">1을 B로</text>
         </g>

         {/* D: The Core Movement! */}
         <g transform="translate(200, 100)">
            <rect width="40" height="40" rx="6" fill="hsl(239 84% 67%)" filter="url(#glow)" />
            <text x="20" y="25" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(0 0% 100%)">D</text>
            <text x="60" y="25" fontSize="18" fontWeight="900" fill="hsl(239 84% 67%)">3을 C로 (가장 큰 판 이동!)</text>
         </g>

         <g transform="translate(60, 160)">
            <rect width="40" height="40" rx="6" fill="hsl(347 89% 60%)" />
            <text x="20" y="25" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(0 0% 100%)">E</text>
            <text x="60" y="25" fontSize="16" fontWeight="bold" fill="hsl(var(--foreground))">1을 A로</text>
         </g>
         <g transform="translate(240, 160)">
            <rect width="40" height="40" rx="6" fill="hsl(347 89% 60%)" />
            <text x="20" y="25" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(0 0% 100%)">F</text>
            <text x="60" y="25" fontSize="16" fontWeight="bold" fill="hsl(var(--foreground))">2를 C로</text>
         </g>
         <g transform="translate(420, 160)">
            <rect width="40" height="40" rx="6" fill="hsl(347 89% 60%)" />
            <text x="20" y="25" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(0 0% 100%)">G</text>
            <text x="60" y="25" fontSize="16" fontWeight="bold" fill="hsl(var(--foreground))">1을 C로</text>
         </g>
      ...
      <rect x="150" y="380" width="500" height="50" rx="25" fill="hsl(var(--muted))" opacity="0.6" stroke="hsl(var(--border))" strokeWidth="1" />
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        A~C (N-1을 B로), <tspan fill="hsl(239 84% 67%)" fontWeight="800">D (큰판 N을 C로)</tspan>, E~G (N-1을 C로) 의 대칭 구조입니다.
      </text>
    </svg>
  );
}
