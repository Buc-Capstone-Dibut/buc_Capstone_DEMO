  ...
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(400, 100)">
        {/* Edges */}
        <path d="M 0 20 L -150 100" stroke="hsl(239 84% 67%)" strokeWidth="3" opacity="0.4" />
        <path d="M 0 20 L 150 100" stroke="hsl(239 84% 67%)" strokeWidth="3" opacity="0.4" />
        <path d="M -150 120 L -220 200" stroke="hsl(239 84% 67%)" strokeWidth="3" opacity="0.4" />
        <path d="M -150 120 L -80 200" stroke="hsl(239 84% 67%)" strokeWidth="3" opacity="0.4" />
        <path d="M 150 120 L 80 200" stroke="hsl(239 84% 67%)" strokeWidth="3" opacity="0.4" />
        <path d="M 150 120 L 220 200" stroke="hsl(239 84% 67%)" strokeWidth="3" opacity="0.4" />
        ...
        <motion.g animate={{ scale: [1, 1.1, 1] }} transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}>
           ...
           <text x="0" y="16" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(0 0% 100%)">fib(4)</text>
        </motion.g>

        {/* Level 1 */}
        <rect x="-190" y="90" width="80" height="40" rx="8" fill="url(#surface-grad)" stroke="hsl(271 91% 65%)" strokeWidth="2" />
        <text x="-150" y="116" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(var(--foreground))">fib(3)</text>

        <rect x="110" y="90" width="80" height="40" rx="8" fill="url(#surface-grad)" stroke="hsl(271 91% 65%)" strokeWidth="2" />
        <text x="150" y="116" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(var(--foreground))">fib(2)</text>

        {/* Level 2 (Base cases & sub) */}
        <rect x="-260" y="190" width="80" height="40" rx="8" fill="url(#surface-grad)" stroke="hsl(239 84% 67%)" strokeWidth="2" />
        <text x="-220" y="216" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(var(--foreground))">fib(2)</text>

        <rect x="-120" y="190" width="80" height="40" rx="8" fill="hsl(160 84% 39%)" opacity="0.8" />
        <text x="-80" y="216" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(0 0% 100%)">fib(1)</text>

        <rect x="40" y="190" width="80" height="40" rx="8" fill="hsl(160 84% 39%)" opacity="0.8" />
        <text x="80" y="216" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(0 0% 100%)">fib(1)</text>

        <rect x="180" y="190" width="80" height="40" rx="8" fill="hsl(160 84% 39%)" opacity="0.8" />
        <text x="220" y="216" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(0 0% 100%)">fib(0)</text>
      ...
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        복잡한 중첩 호출을 <tspan fill="hsl(239 84% 67%)" fontWeight="800">나뭇가지 형태(Tree)</tspan>로 넓게 펼치면 얽힌 실행 흐름이 한눈에 들어옵니다.
      </text>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(150, 100)">
         ...
         <g transform="translate(0, 0)" filter="url(#soft-shadow)">
            ...
            <text x="110" y="30" textAnchor="middle" fontSize="20" fontWeight="900" fill="hsl(239 84% 67%)">1. 하향식 진입</text>

            <rect x="20" y="50" width="180" height="40" rx="6" fill="hsl(239 84% 67%)" opacity="0.1" />
            <text x="110" y="75" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(var(--foreground))">A(4) 호출</text>

            <rect x="20" y="100" width="180" height="40" rx="6" fill="hsl(239 84% 67%)" opacity="0.3" />
            <text x="110" y="125" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(var(--foreground))">A(3) 호출</text>

            <rect x="20" y="150" width="180" height="40" rx="6" fill="hsl(239 84% 67%)" opacity="0.5" />
            <text x="110" y="175" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(var(--foreground))">A(2) 호출</text>

            <rect x="20" y="200" width="180" height="30" rx="6" fill="hsl(160 84% 39%)" />
            <text x="110" y="220" textAnchor="middle" fontSize="14" fontWeight="bold" fill="hsl(0 0% 100%)">A(1) - Base Case 도달</text>
         </g>
         ...
         <g transform="translate(320, 0)" filter="url(#soft-shadow)">
            <rect width="250" height="240" rx="16" fill="url(#surface-grad)" stroke="hsl(160 84% 39%)" strokeWidth="2" />
            <text x="125" y="30" textAnchor="middle" fontSize="20" fontWeight="900" fill="hsl(160 84% 39%)">2. 연산 보류(Pending)</text>

            <text x="20" y="70" fontSize="14" fontWeight="bold" fill="hsl(var(--muted-foreground))">A(4): 4 * <tspan fill="hsl(347 89% 60%)">A(3) 대기 중...</tspan></text>
            <text x="20" y="120" fontSize="14" fontWeight="bold" fill="hsl(var(--muted-foreground))">A(3): 3 * <tspan fill="hsl(347 89% 60%)">A(2) 대기 중...</tspan></text>
            <text x="20" y="170" fontSize="14" fontWeight="bold" fill="hsl(var(--muted-foreground))">A(2): 2 * <tspan fill="hsl(347 89% 60%)">A(1) 대기 중...</tspan></text>

            <motion.path d="M 125 50 L 125 150" stroke="hsl(347 89% 60%)" strokeWidth="3" markerEnd="url(#arrow-head)"
      ...
      <rect x="150" y="380" width="500" height="50" rx="25" fill="hsl(var(--muted))" opacity="0.6" stroke="hsl(var(--border))" strokeWidth="1" />
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        가장 깊은 곳까지 내려가기 전에는 <tspan fill="hsl(347 89% 60%)" fontWeight="800">모든 이전 연산이 미완성 상태로 대기(Pending)</tspan>합니다.
      </text>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(200, 100)">
         ...
         <g transform="translate(0, 180)">
            <rect width="180" height="40" rx="8" fill="hsl(160 84% 39%)" filter="url(#glow)" />
            <text x="90" y="25" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(0 0% 100%)">A(1) = 1 완료!</text>
         </g>

         <motion.path d="M 90 170 L 90 140" stroke="hsl(160 84% 39%)" strokeWidth="4" markerEnd="url(#arrow-head-emerald)"
         ...
         <motion.g transform="translate(0, 90)" animate={{ opacity: [0, 1] }} transition={{ duration: 1, delay: 1 }}>
            <rect width="180" height="40" rx="8" fill="url(#surface-grad)" stroke="hsl(160 84% 39%)" strokeWidth="2" />
            <text x="90" y="25" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(var(--foreground))">A(2) = 2 * <tspan fill="hsl(160 84% 39%)">1</tspan> = 2</text>
         </motion.g>

         <motion.path d="M 90 80 L 90 50" stroke="hsl(160 84% 39%)" strokeWidth="4" markerEnd="url(#arrow-head-emerald)"
         ...
         <motion.g transform="translate(0, 0)" animate={{ opacity: [0, 1] }} transition={{ duration: 1, delay: 2 }}>
            <rect width="180" height="40" rx="8" fill="url(#surface-grad)" stroke="hsl(160 84% 39%)" strokeWidth="2" />
            <text x="90" y="25" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(var(--foreground))">A(3) = 3 * <tspan fill="hsl(160 84% 39%)">2</tspan> = 6</text>
         </motion.g>

         {/* Arrow curving out to Final */}
         <motion.path d="M 190 20 Q 250 20 250 -40 Q 250 -80 320 -80" fill="none" stroke="hsl(239 84% 67%)" strokeWidth="4" markerEnd="url(#arrow-head)" strokeDasharray="6 6"
         ...
         <motion.g transform="translate(330, -100)" filter="url(#glow)" animate={{ opacity: [0, 1], scale: [0.8, 1.1, 1] }} transition={{ duration: 1, delay: 4 }}>
            ...
            <text x="80" y="32" textAnchor="middle" fontSize="20" fontWeight="900" fill="hsl(0 0% 100%)">최종 6 도출!</text>
         </motion.g>
      </g>

      <rect x="150" y="380" width="500" height="50" rx="25" fill="hsl(var(--muted))" opacity="0.6" stroke="hsl(var(--border))" strokeWidth="1" />
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        밑바닥(Base)에서 구한 확실한 값을 토대로, <tspan fill="hsl(160 84% 39%)" fontWeight="800">대기 중이던 식들을 거슬러 올라가며 도출</tspan>합니다.
      </text>
    </svg>
  );
}
      ...
      <g transform="translate(150, 100)" filter="url(#soft-shadow)">
         ...
         <g transform="translate(80, 50)">
            <text x="0" y="0" fontSize="24" fontWeight="800" fill="hsl(var(--foreground))" fontFamily="monospace">
              f(3) = 3 + <tspan fill="hsl(347 89% 60%)">f(2)</tspan>
            </text>
            ...
            <motion.text x="30" y="80" fontSize="24" fontWeight="800" fill="hsl(var(--foreground))" fontFamily="monospace"
              ...
              = 3 + ( <tspan fill="hsl(347 89% 60%)">2 + f(1)</tspan> )
            </motion.text>
            ...
            <motion.text x="30" y="160" fontSize="24" fontWeight="800" fill="hsl(var(--foreground))" fontFamily="monospace"
              ...
              = 3 + ( 2 + ( <tspan fill="hsl(160 84% 39%)">1</tspan> ) )
            </motion.text>
         </g>
         ...
         <motion.g transform="translate(380, 160)" animate={{ opacity: [0, 1], x: [20, 0] }} transition={{ duration: 1, delay: 4.5 }}>
            ...
            <text x="40" y="-3" textAnchor="middle" fontSize="26" fontWeight="900" fill="hsl(0 0% 100%)">= 6</text>
         </motion.g>
      </g>

      <rect x="150" y="380" width="500" height="50" rx="25" fill="hsl(var(--muted))" opacity="0.6" stroke="hsl(var(--border))" strokeWidth="1" />
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        수학에서 변수에 값을 대입하듯, <tspan fill="hsl(239 84% 67%)" fontWeight="800">미지수 함수를 점진적으로 풀어서 식을 완성</tspan>하는 논리입니다.
      </text>
    </svg>
  );
}
