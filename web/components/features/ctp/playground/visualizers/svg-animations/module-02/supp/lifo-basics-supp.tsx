    ...
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(320, 100)">
        ...
        <motion.g animate={{ y: [-80, 60, 60, -80, -80], opacity: [0, 1, 1, 1, 0] }} transition={{ duration: 4, repeat: Infinity, times: [0, 0.3, 0.7, 1] }}>
           <rect width="160" height="50" rx="8" fill="url(#primary-grad)" stroke="hsl(0 0% 100%)" strokeWidth="2" filter="url(#soft-shadow)" />
           <text x="80" y="32" textAnchor="middle" fontSize="20" fontWeight="900" fill="hsl(0 0% 100%)">3 (Last In)</text>
        </motion.g>
      </g>

      {/* Push/Pop annotations */}
      <g transform="translate(180, 100)">
         <motion.path d="M 0 0 C 80 -40 120 -20 180 20" fill="none" stroke="hsl(239 84% 67%)" strokeWidth="4" markerEnd="url(#arrow-head)" strokeDasharray="6 6"
            animate={{ opacity: [1, 1, 0, 0] }} transition={{ duration: 4, repeat: Infinity, times: [0, 0.3, 0.4, 1] }} />
         <motion.text x="30" y="-20" fontSize="18" fontWeight="bold" fill="hsl(239 84% 67%)"
            animate={{ opacity: [1, 1, 0, 0] }} transition={{ duration: 4, repeat: Infinity, times: [0, 0.3, 0.4, 1] }}>Push</motion.text>
      </g>

      <g transform="translate(500, 120)">
         <motion.path d="M 40 40 C 90 20 120 0 160 20" fill="none" stroke="hsl(347 89% 60%)" strokeWidth="4" markerEnd="url(#arrow-head)" strokeDasharray="6 6"
            animate={{ opacity: [0, 0, 1, 1, 0] }} transition={{ duration: 4, repeat: Infinity, times: [0, 0.6, 0.7, 1] }} />
         <motion.text x="100" y="10" fontSize="18" fontWeight="bold" fill="hsl(347 89% 60%)"
      ...
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        나중에 들어간 데이터가 가장 먼저 나오는 <tspan fill="hsl(239 84% 67%)" fontWeight="800">역순 반환 구조</tspan>입니다.
      </text>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(150, 120)">
        ...
        <motion.g animate={{ y: [0, 40, 40, 0] }} transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}>
           <path d="M -80 0 L -20 0" stroke="hsl(347 89% 60%)" strokeWidth="4" markerEnd="url(#arrow-head)" />
           <rect x="-140" y="-15" width="50" height="30" rx="6" fill="hsl(347 89% 60%)" />
           <text x="-115" y="5" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(0 0% 100%)">Top</text>
        </motion.g>
        ...
        <g transform="translate(300, 20)">
           ...
           <g transform="translate(20, 30)">
              <text x="0" y="0" fontSize="18" fontWeight="800" fill="hsl(239 84% 67%)">1. Push(Data)</text>
           ...
           <g transform="translate(20, 80)">
              <text x="0" y="0" fontSize="18" fontWeight="800" fill="hsl(347 89% 60%)">2. Pop()</text>
              <text x="140" y="0" fontSize="18" fontWeight="900" fill="hsl(var(--foreground))">O(1)</text>
              <text x="0" y="25" fontSize="13" fill="hsl(var(--muted-foreground))">Top 위치의 데이터 즉시 반환</text>
           </g>

           <g transform="translate(20, 130)">
              <text x="0" y="0" fontSize="18" fontWeight="800" fill="hsl(160 84% 39%)">3. Peek()</text>
              <text x="140" y="0" fontSize="18" fontWeight="900" fill="hsl(var(--foreground))">O(1)</text>
      ...
      <rect x="150" y="380" width="500" height="50" rx="25" fill="hsl(var(--muted))" opacity="0.6" stroke="hsl(var(--border))" strokeWidth="1" />
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        가장 위쪽의 요소만 조작하므로 데이터 수에 상관없이 항상 <tspan fill="hsl(239 84% 67%)" fontWeight="800">일정한 성능</tspan>을 냅니다.
      </text>
    </svg>
  );
}
...
function BoundaryHandling() {
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      {/* Overflow Scenario */}
      <g transform="translate(150, 120)">
        <text x="80" y="-15" textAnchor="middle" fontSize="18" fontWeight="800" fill="hsl(347 89% 60%)">Stack Overflow</text>
        ...
        >
           ...
           <text x="80" y="-15" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(0 0% 100%)">NEW (거부됨)</text>
        </motion.g>
      ...
      <g transform="translate(480, 120)">
        <text x="80" y="-15" textAnchor="middle" fontSize="18" fontWeight="800" fill="hsl(239 84% 67%)">Stack Underflow</text>
        <path d="M 0 0 L 0 160 L 160 160 L 160 0" fill="none" stroke="hsl(var(--border))" strokeWidth="4" />
        ...
        <motion.g animate={{ x: [0, 20, -20, 0] }} transition={{ duration: 0.5, repeat: Infinity, repeatDelay: 1.5 }}>
           <rect x="40" y="-80" width="80" height="40" rx="6" fill="none" stroke="hsl(239 84% 67%)" strokeWidth="3" strokeDasharray="4 4" />
           <text x="80" y="-55" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(239 84% 67%)">POP (실패)</text>
           <motion.path d="M 80 0 L 80 -40" stroke="hsl(239 84% 67%)" strokeWidth="4" markerEnd="url(#arrow-head)"
      ...
      <rect x="150" y="380" width="500" height="50" rx="25" fill="hsl(var(--muted))" opacity="0.6" stroke="hsl(var(--border))" strokeWidth="1" />
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        스택의 한계를 넘는 요청을 방어하기 위해 <tspan fill="hsl(347 89% 60%)" fontWeight="800">isFull(), isEmpty()</tspan> 검사가 필수적입니다.
      </text>
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(150, 100)" filter="url(#soft-shadow)">
        ...
        {/* Validation Target */}
        <motion.rect x="300" y="10" width="40" height="40" fill="none" stroke="hsl(239 84% 67%)" strokeWidth="3" rx="4"
        ...
        <g transform="translate(180, 80)">
           ...
           <motion.g animate={{ y: [0, 40, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}>
             <rect x="20" y="60" width="100" height="30" rx="6" fill="hsl(160 84% 39%)" opacity="0.8" />
             <text x="70" y="80" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(0 0% 100%)"> ( </text>
             <path d="M 125 75 L 160 75" fill="none" stroke="hsl(160 84% 39%)" strokeWidth="3" markerEnd="url(#arrow-head)" strokeDasharray="4 4" />
             <text x="210" y="80" fontSize="14" fontWeight="bold" fill="hsl(160 84% 39%)">짝이 맞으면 Pop</text>
           </motion.g>

           <rect x="20" y="85" width="100" height="30" rx="6" fill="hsl(239 84% 67%)" opacity="0.8" />
           <text x="70" y="105" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(0 0% 100%)"> [ </text>
        </g>
      </g>
      ...
      <text x="400" y="390" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        최근 상태나 연산을 <tspan fill="hsl(239 84% 67%)" fontWeight="800">임시 기억하고 역순으로 되돌릴 때</tspan> (실행취소, DFS, 괄호 검사) 사용합니다.
      </text>
    </svg>
  );
}
