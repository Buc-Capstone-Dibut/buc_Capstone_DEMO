    ...
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(150, 100)">
         ...
         <g transform="translate(0, 0)" filter="url(#soft-shadow)">
            <rect width="200" height="250" rx="16" fill="url(#surface-grad)" stroke="hsl(347 89% 60%)" strokeWidth="2" />
            <text x="100" y="30" textAnchor="middle" fontSize="18" fontWeight="bold" fill="hsl(347 89% 60%)">순수 재귀 (Recursion)</text>

            <g transform="translate(40, 60)">
               <motion.rect y="0" width="120" height="35" rx="6" fill="hsl(347 89% 60%)" opacity="0.3" animate={{ opacity: [0.3, 0.8, 0.3] }} transition={{ duration: 1, repeat: Infinity, delay: 0 }} />
               <motion.rect y="45" width="120" height="35" rx="6" fill="hsl(347 89% 60%)" opacity="0.3" animate={{ opacity: [0.3, 0.8, 0.3] }} transition={{ duration: 1, repeat: Infinity, delay: 0.2 }} />
               <motion.rect y="90" width="120" height="35" rx="6" fill="hsl(347 89% 60%)" opacity="0.3" animate={{ opacity: [0.3, 0.8, 0.3] }} transition={{ duration: 1, repeat: Infinity, delay: 0.4 }} />
               <motion.rect y="135" width="120" height="35" rx="6" fill="hsl(347 89% 60%)" opacity="0.3" animate={{ opacity: [0.3, 0.8, 0.3] }} transition={{ duration: 1, repeat: Infinity, delay: 0.6 }} />

               <path d="M 60 -10 L 60 180" stroke="hsl(347 89% 60%)" strokeWidth="4" strokeDasharray="4 4" markerEnd="url(#arrow-head)" opacity="0.5" />
            </g>
         ...
         <g transform="translate(300, 0)" filter="url(#soft-shadow)">
            <rect width="200" height="250" rx="16" fill="url(#surface-grad)" stroke="hsl(160 84% 39%)" strokeWidth="2" />
            <text x="100" y="30" textAnchor="middle" fontSize="18" fontWeight="bold" fill="hsl(160 84% 39%)">반복문 (Iteration)</text>

            <g transform="translate(40, 100)">
               <rect y="0" width="120" height="60" rx="6" fill="hsl(160 84% 39%)" opacity="0.2" />
               <text x="60" y="35" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(160 84% 39%)">루프 블록</text>

               {/* Loop Animation */}
               <motion.path d="M -10 30 C -40 0, 160 0, 130 30" fill="none" stroke="hsl(160 84% 39%)" strokeWidth="3" markerEnd="url(#arrow-head)"
                  animate={{ opacity: [0, 1, 0] }} transition={{ duration: 1.5, repeat: Infinity, ease: "easeInOut" }} />
               <motion.path d="M -10 30 C -40 60, 160 60, 130 30" fill="none" stroke="hsl(160 84% 39%)" strokeWidth="3" markerEnd="url(#arrow-head)"
      ...
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        재귀 호출은 함수 레지스터 백업 및 복구 작업 때문에 반복문보다 <tspan fill="hsl(347 89% 60%)" fontWeight="800">속도가 느립니다.</tspan>
      </text>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(150, 100)">
         ...
         <g transform="translate(0, 0)">
            <text x="100" y="20" textAnchor="middle" fontSize="18" fontWeight="bold" fill="hsl(347 89% 60%)">재귀 (O(N) Space)</text>
            <path d="M 50 40 L 50 200 L 150 200 L 150 40" fill="none" stroke="hsl(var(--border))" strokeWidth="4" />

            {/* Stack Filling Animation */}
            <motion.rect x="55" y="160" width="90" height="30" fill="hsl(347 89% 60%)" opacity="0.8" animate={{ height: [30, 150, 30], y: [160, 40, 160] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }} />
            <rect x="55" y="160" width="90" height="30" fill="hsl(347 89% 60%)" />
            <text x="100" y="180" textAnchor="middle" fontSize="14" fill="hsl(0 0% 100%)">Main</text>
         ...
         <motion.path d="M 220 120 L 280 120" stroke="hsl(239 84% 67%)" strokeWidth="4" markerEnd="url(#arrow-head)" strokeDasharray="6 6"
            animate={{ x: [0, 10, 0] }} transition={{ duration: 1.5, repeat: Infinity, ease: "easeInOut" }} />

         {/* O(1) Space */}
         <g transform="translate(300, 0)">
            <text x="100" y="20" textAnchor="middle" fontSize="18" fontWeight="bold" fill="hsl(160 84% 39%)">반복 (O(1) Space)</text>
            <path d="M 50 40 L 50 200 L 150 200 L 150 40" fill="none" stroke="hsl(var(--border))" strokeWidth="4" />

            {/* Static Single Frame Animation */}
            <rect x="55" y="160" width="90" height="30" fill="hsl(160 84% 39%)" />
            <text x="100" y="180" textAnchor="middle" fontSize="14" fill="hsl(0 0% 100%)">Main</text>

            <motion.circle cx="100" cy="175" r="10" fill="none" stroke="hsl(0 0% 100%)" strokeWidth="3"
      ...
      <rect x="150" y="380" width="500" height="50" rx="25" fill="hsl(var(--muted))" opacity="0.6" stroke="hsl(var(--border))" strokeWidth="1" />
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        반복문은 아무리 많이 돌아도 <tspan fill="hsl(160 84% 39%)" fontWeight="800">단 하나의 스택 프레임(상수 공간)</tspan>만 소모합니다.
      </text>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(100, 100)" filter="url(#soft-shadow)">
         ...
         <g transform="translate(50, 30)">
            <text x="0" y="0" fontSize="18" fontWeight="bold" fill="hsl(347 89% 60%)">일반 재귀 (돌아와서 할 일이 남음)</text>
            <text x="0" y="30" fontSize="16" fill="hsl(var(--foreground))" fontFamily="monospace">return <tspan fill="hsl(347 89% 60%)">n *</tspan> fact(n-1);</text>

            <g transform="translate(0, 60)">
               <rect width="80" height="30" rx="4" fill="hsl(347 89% 60%)" opacity="0.5" />
               <rect y="-10" width="80" height="30" rx="4" fill="hsl(347 89% 60%)" opacity="0.7" />
               <rect y="-20" width="80" height="30" rx="4" fill="hsl(347 89% 60%)" />
         ...
         <g transform="translate(50, 150)">
            <text x="0" y="0" fontSize="18" fontWeight="bold" fill="hsl(239 84% 67%)">꼬리 재귀 (돌아와서 할 일이 없음)</text>
            <text x="0" y="30" fontSize="16" fill="hsl(var(--foreground))" fontFamily="monospace">return fact(n-1, <tspan fill="hsl(239 84% 67%)">n * acc</tspan>);</text>

            <g transform="translate(0, 60)">
               {/* Reusing the same frame animation */}
               <motion.rect width="80" height="30" rx="4" fill="hsl(239 84% 67%)"
                  animate={{ scaleX: [1, 1.1, 1], fill: ["hsl(239 84% 67%)", "hsl(234 89% 74%)", "hsl(239 84% 67%)"] }} transition={{ duration: 1, repeat: Infinity }} />

               <path d="M 90 15 C 150 -10 150 40 90 15" fill="none" stroke="hsl(239 84% 67%)" strokeWidth="3" markerEnd="url(#arrow-head)" />
      ...
      <rect x="150" y="380" width="500" height="50" rx="25" fill="hsl(var(--muted))" opacity="0.6" stroke="hsl(var(--border))" strokeWidth="1" />
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        재귀 호출을 맨 마지막에 단독으로 배치하면 <tspan fill="hsl(239 84% 67%)" fontWeight="800">반복문과 동일한 효율</tspan>로 최적화가 가능합니다.
      </text>
    </svg>
  );
}
...
function TradeoffGuide() {
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <rect x="150" y="380" width="500" height="50" rx="25" fill="hsl(var(--muted))" opacity="0.6" stroke="hsl(var(--border))" strokeWidth="1" />
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        <tspan fill="hsl(239 84% 67%)" fontWeight="800">가독성(유지보수)</tspan>이냐 <tspan fill="hsl(160 84% 39%)" fontWeight="800">극한의 성능</tspan>이냐에 따라 현명하게 선택해야 합니다.
      </text>
    </svg>
  );
}
