    ...
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(150, 150)">
         ...
         <motion.g animate={{ opacity: [0, 0, 1, 1, 1] }} transition={{ duration: 6, repeat: Infinity, times: [0, 0.2, 0.3, 1, 1] }}>
            ...
            <text x="245" y="55" textAnchor="middle" fontSize="28" fontWeight="bold" fill="hsl(0 0% 100%)">B</text>
         </motion.g>
         ...
         <motion.g animate={{ x: [145, 145, 245, 245, 145] }} transition={{ duration: 6, repeat: Infinity, times: [0, 0.6, 0.7, 1, 1], ease: "easeInOut" }}>
            <path d="M 0 110 L 0 150" stroke="hsl(347 89% 60%)" strokeWidth="4" />
            <polygon points="-10,110 10,110 0,95" fill="hsl(347 89% 60%)" />
            <rect x="-30" y="160" width="60" height="30" rx="6" fill="hsl(347 89% 60%)" />
            <text x="0" y="180" textAnchor="middle" fontSize="14" fontWeight="900" fill="hsl(0 0% 100%)">Front</text>
         </motion.g>
         ...
         <motion.g animate={{ x: [145, 245, 245, 245, 145] }} transition={{ duration: 6, repeat: Infinity, times: [0, 0.2, 0.3, 1, 1], ease: "easeInOut" }}>
            <path d="M 0 -20 L 0 20" stroke="hsl(239 84% 67%)" strokeWidth="4" />
            <polygon points="-10,20 10,20 0,35" fill="hsl(239 84% 67%)" />
            <rect x="-30" y="-60" width="60" height="30" rx="6" fill="hsl(239 84% 67%)" />
            <text x="0" y="-40" textAnchor="middle" fontSize="14" fontWeight="900" fill="hsl(0 0% 100%)">Rear</text>
         </motion.g>
      ...
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        연산이 일어날 때마다 <tspan fill="hsl(239 84% 67%)" fontWeight="800">Front</tspan>와 <tspan fill="hsl(347 89% 60%)" fontWeight="800">Rear</tspan>가 우측으로 계속 전진합니다.
      </text>
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(150, 150)">
         {/* Array Slots */}
         {[0, 1, 2, 3, 4].map((i) => (
            <rect key={i} x={i * 100} y="0" width="90" height="90" rx="12" fill={i < 2 ? "url(#emerald-grad)" : "url(#surface-grad)"} opacity={i < 2 ? 0.1 : 1} stroke={i < 2 ? "hsl(160 84% 39%)" : "hsl(var(--border))"} strokeWidth="2" strokeDasharray={i < 2 ? "6 6" : "0"} filter="url(#soft-shadow)" />
         ))}
         <text x="45" y="50" textAnchor="middle" fontSize="14" fontWeight="bold" fill="hsl(160 84% 39%)">빈 공간</text>
         <text x="145" y="50" textAnchor="middle" fontSize="14" fontWeight="bold" fill="hsl(160 84% 39%)">빈 공간</text>
         ...
         <path d="M 445 -20 L 445 20" stroke="hsl(239 84% 67%)" strokeWidth="4" />
         <polygon points="435,20 455,20 445,35" fill="hsl(239 84% 67%)" />
         <rect x="415" y="-60" width="60" height="30" rx="6" fill="hsl(239 84% 67%)" />
         <text x="445" y="-40" textAnchor="middle" fontSize="14" fontWeight="900" fill="hsl(0 0% 100%)">Rear</text>
         ...
         <motion.g animate={{ x: [0, -20, 0] }} transition={{ duration: 1, repeat: Infinity }}>
            ...
            <text x="570" y="50" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(0 0% 100%)">새 데이터 삽입</text>
            <path d="M 520 45 L 490 45" stroke="hsl(347 89% 60%)" strokeWidth="4" markerEnd="url(#arrow-head)" />
         </motion.g>

         <motion.text x="445" y="-80" textAnchor="middle" fontSize="16" fontWeight="900" fill="hsl(347 89% 60%)"
            animate={{ opacity: [1, 0, 1] }} transition={{ duration: 1, repeat: Infinity }}>배열 끝 도달! (실패)</motion.text>
      </g>

      <rect x="150" y="380" width="500" height="50" rx="25" fill="hsl(var(--muted))" opacity="0.6" stroke="hsl(var(--border))" strokeWidth="1" />
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        앞쪽에 빈 공간이 있어도 <tspan fill="hsl(347 89% 60%)" fontWeight="800">Rear가 끝에 닿아</tspan> 더 이상 넣을 수 없는 한계가 옵니다.
      </text>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(150, 120)" filter="url(#soft-shadow)">
         ...
         <g transform="translate(50, 40)">
            ...
            <text x="20" y="25" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(0 0% 100%)">1</text>
            <text x="60" y="25" fontSize="18" fontWeight="800" fill="hsl(160 84% 39%)">초기 상태 (Empty)</text>
         ...
         <g transform="translate(50, 160)">
            ...
            <text x="20" y="25" textAnchor="middle" fontSize="16" fontWeight="bold" fill="hsl(0 0% 100%)">2</text>
            <text x="60" y="25" fontSize="18" fontWeight="800" fill="hsl(347 89% 60%)">포화 상태 (Full)</text>
         ...
         <motion.g transform="translate(360, 60)" animate={{ scale: [1, 1.1, 1] }} transition={{ duration: 2, repeat: Infinity }}>
            ...
            <path d="M 50 20 L 50 60" stroke="hsl(347 89% 60%)" strokeWidth="4" strokeLinecap="round" />
            <circle cx="50" cy="75" r="4" fill="hsl(347 89% 60%)" />
            <text x="50" y="95" textAnchor="middle" fontSize="12" fontWeight="bold" fill="hsl(347 89% 60%)">front &gt; rear 시</text>
            <text x="50" y="110" textAnchor="middle" fontSize="12" fontWeight="bold" fill="hsl(347 89% 60%)">Empty 판별 주의</text>
         </motion.g>
      </g>

      <rect x="150" y="380" width="500" height="50" rx="25" fill="hsl(var(--muted))" opacity="0.6" stroke="hsl(var(--border))" strokeWidth="1" />
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        구현 방법에 따라 <tspan fill="hsl(239 84% 67%)" fontWeight="800">조건식이 미세하게 달라지므로</tspan> 경계값을 명확히 정의해야 합니다.
      </text>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 800 450" className="w-full h-full font-sans select-none" style={{ backgroundColor: "hsl(var(--background))" }}>
      ...
      <g transform="translate(150, 150)">
         ...
         <g transform="translate(0, 0)">
            ...
            <text x="100" y="15" textAnchor="middle" fontSize="13" fontWeight="bold" fill="hsl(347 89% 60%)">선형 큐의 한계</text>
            <rect x="10" y="30" width="180" height="20" rx="4" fill="hsl(347 89% 60%)" opacity="0.3" />
            <path d="M 190 30 L 220 30" stroke="hsl(347 89% 60%)" strokeWidth="4" markerEnd="url(#arrow-head)" strokeDasharray="4 4" />
            <text x="100" y="45" textAnchor="middle" fontSize="12" fontWeight="bold" fill="hsl(347 89% 60%)">버려진 앞 공간</text>
         </g>

         {/* Evolution Arrow */}
         <motion.path d="M 230 30 Q 250 -40 300 30" fill="none" stroke="hsl(239 84% 67%)" strokeWidth="4" markerEnd="url(#arrow-head)" strokeDasharray="6 6"
            animate={{ pathLength: [0, 1] }} transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }} />
         <text x="265" y="-10" textAnchor="middle" fontSize="14" fontWeight="bold" fill="hsl(239 84% 67%)">구부리기</text>
         ...
         <g transform="translate(360, 0)">
            ...
            <text x="60" y="35" textAnchor="middle" fontSize="16" fontWeight="900" fill="hsl(160 84% 39%)">원형 큐</text>

            <motion.path d="M 60 -10 A 40 40 0 1 1 59.9 -10" fill="none" stroke="hsl(160 84% 39%)" strokeWidth="15" strokeDasharray="30 20"
      ...
      <rect x="150" y="380" width="500" height="50" rx="25" fill="hsl(var(--muted))" opacity="0.6" stroke="hsl(var(--border))" strokeWidth="1" />
      <text x="400" y="410" textAnchor="middle" fontSize="15" fontWeight="600" fill="hsl(var(--foreground))">
        배열의 양 끝을 동그랗게 이어붙여 <tspan fill="hsl(160 84% 39%)" fontWeight="800">낭비되는 메모리 슬롯을 무한 재활용</tspan>합니다.
      </text>
    </svg>
  );
}
