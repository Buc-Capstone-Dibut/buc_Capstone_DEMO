...
class Settings(BaseSettings):
    ...
    voice_vad_speech_start_ms: int = Field(default=170, alias="VOICE_VAD_SPEECH_START_MS")
    voice_vad_silence_ms: int = Field(default=680, alias="VOICE_VAD_SILENCE_MS")
    ...
    voice_turn_end_grace_ms: int = Field(default=120, alias="VOICE_TURN_END_GRACE_MS")
